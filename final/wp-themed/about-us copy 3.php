...
.label {
  ...
  font-size: clamp(0.64rem, 0.58vw, 0.7rem);
  font-weight: 400;
...
.testi-stars {
  ...
  margin-bottom: 22px;
  color: #e8a400;
  font-size: clamp(0.78rem, 0.76vw, 0.85rem);
...
.team-role {
  font-family: var(--mono);
  font-size: clamp(0.58rem, 0.5vw, 0.64rem);
  letter-spacing: 0.14em;
  text-transform: uppercase;
  color: var(--gold);
  line-height: 1.6;
...
.guar-badge-lbl {
  font-family: var(--mono);
  font-size: clamp(0.53rem, 0.34vw, 0.57rem);
  ...
  <div class="opt-c-inner">
    <div class="sect-head on-dark solo-head">
      <div>
        ...
        <h2>Three specialists each brings <em>a depth of relevant expertise &amp; provides fast turnaround</em>
        </h2>
      </div>
    </div>
    ...
    <div class="testimonials-grid">
      <div class="testi-card reveal">
        ...
        <div class="testi-author">
          <span class="testi-name">Christopher OHalloran</span>
          <span class="testi-role">Owner <br />The Green Inn - Ballater </span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d1">
        ...
        <div class="testi-author">
          <span class="testi-name">Ameer Aslam</span>
          <span class="testi-role">Owner <br /> Nickel & Dime – Various</span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d2">
        ...
        <div class="testi-author">
          <span class="testi-name">Nathan Davies</span>
          <span class="testi-role">Director <br /> Badenoch’s – Elgin </span>
        </div>
      </div>
    </div>
  </div>
