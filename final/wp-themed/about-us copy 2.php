...
<section class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-sub reveal d2">
        <p>
          Fellow of the Association of Chartered Certified Accountants (FCCA) and Economics (Honours) graduate of the
          University of Aberdeen, our founder went on to manage complex international group accounts at Subsea 7, a
          multibillion-pound oil and gas contractor, to Big 4 audit standards imposed by Deloitte and EY.
        </p>
        <p>
          A2Z was founded after seeing growing businesses consistently underserved by accountants treating compliance as
          a box-ticking exercise &mdash; and built the finance function they deserved.
        </p>
        <p>
          A2Z is not a compliance only firm. It is the fully managed finance function that ambitious businesses deserve.
        </p>
      </div>
...
<section class="team">
  <div class="team-inner">
    <div class="team-head reveal">
      ...
      <h2 class="display-lg" style="margin-top: 0px">
        Built for fast, accurate<br /><em>financial support.</em>
      </h2>
      <p>
        A2Z is structured around specialist roles rather than one generalist accountant. Each profile reflects the areas
        clients rely on most: director oversight, payroll, VAT, bookkeeping, tax, and day-to-day client support.
      </p>
    </div>
    ...
    <div class="team-grid">
      <article class="team-card reveal">
        ...
        <div class="team-body">
          <h3>Shabbir Rahman, FCCA</h3>
          <div class="team-role">Founder &amp; Chief Executive</div>
          <p>
            Director-level oversight across client engagements, drawing on Subsea 7 group-accounting experience and Big
            4 audit standards from Deloitte and EY.
          </p>
        </div>
      </article>

      <article class="team-card reveal d1">
        <div class="team-photo"><span class="team-initials">M</span></div>
        <div class="team-body">
          <h3>Mahfuza</h3>
          <div class="team-role">Client Accounts Support</div>
          <p>
            Supports clients with practical accounting queries, document handling, and prompt resolution of tax-return
            and compliance issues.
          </p>
        </div>
      </article>

      <article class="team-card reveal d2">
        <div class="team-photo"><span class="team-initials">E</span></div>
        <div class="team-body">
          <h3>Emma</h3>
          <div class="team-role">Accounting Team Support</div>
          <p>
            Helps keep client communication moving quickly, coordinating records, follow-ups, and day-to-day accounting
            support across the team.
          </p>
        </div>
      </article>

      <article class="team-card reveal d3">
        <div class="team-photo"><span class="team-initials">A2Z</span></div>
        <div class="team-body">
          <h3>Specialist Team</h3>
          <div class="team-role">Payroll, VAT, Accounts &amp; Tax</div>
          <p>
            Department-led specialists handle the technical work behind payroll, VAT, management accounts, year-end
...
<section class="principles">
  <div class="principles-inner">
    <div class="principles-head solo-head">
    ...
    <div class="principles-grid">
      <article class="principle-item reveal">
        ...
        <p>
          Low quality accounting creates expensive problems. We price for the value
          delivered: certainty, accuracy, and measurable strategic advantage.
        </p>
      </article>
    ...
    <div class="principles-manifesto reveal cta-only">
...
<section class="layers">
  <div class="layers-inner">
    <div class="layers-head solo-head">
...
<section class="opt-c">
  <div class="opt-c-inner">
    <div class="sect-head on-dark solo-head">
      <div>
        <!--         <span class="sect-head-eyebrow">Fully Managed Accounting Support</span> -->
        <h2>Three specialists.<br /><em>Each brings a depth of relevant expertise &amp; provides fast turnaround.</em></h2>
      </div>
    </div>
...
<section class="testimonials">
  <div class="testimonials-inner">
    <div class="testimonials-head reveal">
      ...
      <p>
        UK businesses trust A2Z with their financial management. Here is
        what a few verified clients say in their own words. You can read
    ...
    <div class="testimonials-grid">
      <div class="testi-card reveal">
        ...
        <p class="testi-quote">
          An accountancy company that is not only efficient and fantastic to work with. But also helps to take the
          overwhelm out of accounting, offering solutions to suit each clients needs.
        </p>
        <div class="testi-author">
          <span class="testi-name">Amanda Nasser</span>
          <span class="testi-role">Verified Google Review</span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d1">
        <div class="testi-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        <p class="testi-quote">
          I have had a great experience with the A2Z Accounting team. They communicate well and are always happy to
          help. Shabbir himself is always on hand to answer any questions I might have.
        </p>
        <div class="testi-author">
          <span class="testi-name">Matthew Foy</span>
          <span class="testi-role">Verified Google Review</span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d2">
        <div class="testi-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
        <p class="testi-quote">
          Every team member is exceptionally supportive, always quick to assist and resolve. A2Z handle everything while
          I focus on growing my business.
        </p>
        <div class="testi-author">
          <span class="testi-name">Mrs. Lisa Morrison</span>
          <span class="testi-role">Treasurer, Seaforth Club</span>
        </div>
      </div>
    </div>
  </div>
