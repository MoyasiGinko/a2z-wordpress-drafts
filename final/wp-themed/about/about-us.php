...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   A2Z HERO VIDEO TESTIMONIALS â€” fully isolated namespace
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   HERO â€” small-screen refinements.
   ...
   Scoped to hero classes â€” nothing else is affected.
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */

/* Phones â€” let the testimonial card controls wrap on very narrow
...
/* Story section â€” founder journey header */
...
/* Story section â€” founder profile (right column) */
.story-founder {
  display: grid;
...
.prof-standing-strip span::first-line {
  color: var(--gold);
}

.prof-standing-icon-wrap {
  width: 64px;
  height: 64px;
  background: var(--gold);
  border-radius: 50%;
...
@media screen and (max-width: 991px) {
  .prof-standing-icon-wrap path,
  .prof-standing-icon-wrap circle,
  .prof-standing-icon-wrap polyline {
    stroke: #ffffff !important;
...
@media (max-width: 820px) {
  ...
  .cmp-table tbody td.cmp-cat {
    font-size: 1.25rem;
    font-weight: 600;
    color: var(--white);
    border-bottom: 1px solid rgba(176, 141, 87, 0.2) !important;
    text-align: left;
    margin-bottom: 8px;
    padding-top: 8px;
    padding-bottom: 12px;
  ...
  .cmp-table tbody td.cmp-typical, 
  .cmp-table tbody td.cmp-a2z {
    display: flex !important;
  ...
  .cmp-table tbody td.cmp-typical::before, 
  .cmp-table tbody td.cmp-a2z::before {
...
<!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   FOUNDER PROFILE (CLASSIC PREMIUM)
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
<style>
.fp-classic-sec {
  background: #ffffff;
  padding: clamp(80px, 10vw, 120px) clamp(24px, 5vw, 72px) 0 clamp(24px, 5vw, 72px);
  position: relative;
}
...
.fp-classic-image-box {
  position: relative;
  z-index: 1;
}

/* Layer 1: Vibrant Yellow Glassmorphic offset to the bottom right */
.fp-classic-image-box::before {
  content: '';
  position: absolute;
  top: 30px; 
  left: 30px; 
  right: -30px; 
  bottom: -30px;
  background: rgba(212, 168, 79, 0.85); /* Vibrant Brand Yellow */
  backdrop-filter: blur(12px);
  -webkit-backdrop-filter: blur(12px);
  border: 1px solid rgba(255, 255, 255, 0.2);
  box-shadow: 0 15px 35px rgba(212, 168, 79, 0.25);
  border-radius: 8px;
  z-index: -2;
  transition: transform 0.5s ease;
}

/* Layer 2: Vibrant Navy Glassmorphic offset to the top left */
.fp-classic-image-box::after {
  content: '';
  position: absolute;
  top: -20px; 
  left: -20px; 
  width: 100%; 
  height: 100%;
  background: rgba(9, 26, 47, 0.85); /* Vibrant Brand Navy Blue */
  backdrop-filter: blur(12px);
  -webkit-backdrop-filter: blur(12px);
  border: 1px solid rgba(255, 255, 255, 0.1);
  box-shadow: 0 15px 35px rgba(9, 26, 47, 0.3);
  border-radius: 8px;
  z-index: -1;
  transition: transform 0.5s ease;
}

.fp-classic-image-box:hover::before {
  transform: translate(10px, 10px);
}

.fp-classic-image-box:hover::after {
  transform: translate(-10px, -10px);
}

.fp-classic-image-box img {
  width: 100%;
  height: auto;
  display: block;
  object-fit: cover;
...
<section class="fp-classic-sec">
  <div class="fp-classic-grid reveal">
    
    <!-- Image Box -->
    <div class="fp-classic-image-box">
      <img src="https://a2zaccounting.co.uk/wp-content/uploads/2026/04/srahman.png" alt="Shabbir Rahman, Founder" />
    </div>

    <!-- Content Area -->
    <div class="fp-classic-content">
      
      <!-- Top Header Row -->
      <div class="fp-classic-header">
        <span class="fp-classic-label">Founder &amp; Chief Executive</span>
        <h2 class="fp-classic-name">Shabbir Rahman</h2>
        <span class="fp-classic-creds">FCCA &bull; Econ (Hons)</span>
      </div>

      <!-- Bio Grid Rows -->
      <div class="fp-classic-bio-list">
        <div class="fp-classic-bio-item">
          <h4>Qualifications</h4>
          <p>Fellow Chartered Certified Accountant, the highest designation the profession awards, and a First Class Honours graduate in Economics from the University of Aberdeen.</p>
        </div>
        <div class="fp-classic-bio-item">
          <h4>Corporate Background</h4>
          <p>Built his corporate finance experience at Subsea 7, a multibillion-pound oil and gas contractor operating across international markets.</p>
        </div>
        <div class="fp-classic-bio-item">
          <h4>Audit Discipline</h4>
          <p>Operated to the full rigour of Big 4 audit standards, with the accounts audited by Deloitte and EY. The same discipline now governs every A2Z engagement.</p>
        </div>
      </div>
...
<style>
/* =======================================================
   FOUNDER MESSAGE (ELEGANT LETTER AESTHETIC)
   ======================================================= */
.fm-letter-sec {
  background: #ffffff;
  padding: clamp(80px, 8vw, 100px) clamp(24px, 5vw, 72px) clamp(100px, 10vw, 140px);
...
.fm-letter-pullquote::after {
  content: '\201D';
  margin: 48px auto 0 auto;
}

.fm-letter-pullquote span {
  color: var(--gold);
}
...
<section class="fm-letter-sec">
  <div class="fm-letter-inner">
    <div class="fm-letter-header reveal">
      A Message From Our Founder
    </div>
    
    <div class="fm-letter-body reveal d1">
      ...
      <div class="fm-letter-pullquote reveal d2">
        We did not set out to build another accounting firm. We built the <span>finance function</span> growing businesses deserve, and could rarely access until now.
      </div>
...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
<section class="team-quote-band" style="background: linear-gradient(155deg, rgba(2, 8, 17, 0.88) 0%, rgba(9, 26, 47, 0.85) 50%, rgba(2, 8, 17, 0.9) 100%), url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1600&q=80') center/cover no-repeat fixed; padding: clamp(80px, 10vw, 120px) clamp(24px, 5vw, 72px) clamp(80px, 10vw, 120px) clamp(24px, 5vw, 72px);">
  <div class="team-quote-inner" style="text-align: center; max-width: 1000px; margin: 0 auto;">
    <span class="label reveal" style="display: inline-block; margin-bottom: 24px; color: var(--gold); letter-spacing: 0.15em; font-size: 1.2rem; font-weight: 700; background: none; border: none; padding: 0;">THE TEAM BEHIND YOUR NUMBERS</span>
    <h2 class="display-lg reveal d1" style="color: #fff; margin-bottom: 24px;">
      A specialist for <em style="color: var(--gold);">every part of your finances</em>
    </h2>
...
<section class="metrics" aria-label="Key performance metrics">
  <div class="metrics-inner">
    ...
    <div class="metric-item reveal d2">
      ...
      <span class="metric-lbl">Missed deadlines,<br />ever</span>
    </div>
    <div class="metric-item reveal d3">
      <span class="metric-num">£0</span>
      <span class="metric-lbl">HMRC penalties,<br />ever</span>
    </div>
</div>
  </div>
</section>
...
<script>
    /* â”€â”€â”€ a2zvt hero testimonials slider (3-column) â”€â”€â”€ */
    document.addEventListener('DOMContentLoaded', function() {
      ...
      <div class="guar-panel reveal">
        ...
        <div class="guar-panel-body">
          ...
          <p>Any query submitted before midday on a working day receives a substantive response the same day. Not an
            acknowledgement â€” a real answer.</p>
        </div>
      </div>
  ...
  <div class="story-inner">
    ...
    <div class="story-chain story-journey">
      ...
      <article class="sp-item" data-story-idx="0">
        ...
        <div class="sp-body">
          <span class="label" style="margin-bottom: 10px; display: block;">Big 4 Â· Early Career</span>
          <p>Trained under rigorous audit standards at Deloitte and EY â€” absorbing the frameworks, controls, and
      ...
      <article class="sp-item" data-story-idx="1">
        ...
        <div class="sp-body">
          <span class="label" style="margin-bottom: 10px; display: block;">Subsea 7 Â· Group Finance</span>
          <p>Moved into group-accounting leadership at Subsea 7, a FTSE-listed energy contractor â€” overseeing
      ...
      <article class="sp-item" data-story-idx="2">
        ...
        <div class="sp-body">
          <span class="label" style="margin-bottom: 10px; display: block;">FCCA Â· Fellow Qualification</span>
          <p>Achieved Fellow Chartered Certified Accountant status â€” recognition reserved for practitioners who combine
      ...
      <article class="sp-item" data-story-idx="3">
        ...
        <div class="sp-body">
          <span class="label" style="margin-bottom: 10px; display: block;">A2Z Accounting Â· Founded</span>
          <p>Left corporate finance to apply that same rigour â€” specialist roles, director oversight, clear
            accountability â€” to growing UK businesses that deserve more than a generalist filing service. A2Z was built
      ...
      <article class="sp-item" data-story-idx="4">
        ...
        <div class="sp-body">
          <span class="label" style="margin-bottom: 10px; display: block;">Today Â· Leading the Team</span>
          <p>Now leads a specialist team of accountants, payroll administrators, and client support staff â€” each with
            defined responsibilities across VAT, tax, bookkeeping, and year-end accounts â€” so clients always know who
  ...
  <div class="comparison-inner">
    ...
    <table class="cmp-table reveal d1">
      <thead>
        <tr>
          <th>
            <span class="cmp-th-label">Differences</span>
          </th>
          <th>
            <span class="cmp-th-label">Industry standard</span>
            <span class="cmp-th-brand">A Typical Firm</span>
          </th>
          <th>
      ...
      <tbody>
        <tr>
          <td class="cmp-cat">Who handles it</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">One stretched generalist</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">A dedicated specialist team</td>
        </tr>
        <tr>
          <td class="cmp-cat">Qualification</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">Often a junior, undisclosed</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">Reviewed to FCCA standard</td>
        </tr>
        <tr>
          <td class="cmp-cat">Response time</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">Days, or no reply</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">Same-day before midday</td>
        </tr>
        <tr>
          <td class="cmp-cat">Deadlines</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">Reactive, last minute</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">Tracked early. Zero missed, ever</td>
        </tr>
        <tr>
          <td class="cmp-cat">Tax planning</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">You ask, they react</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">Planned months ahead</td>
        </tr>
        <tr>
          <td class="cmp-cat">Fees</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">Hourly, scope creeps</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">One fixed fee, in writing</td>
        </tr>
        <tr>
          <td class="cmp-cat">Sector knowledge</td>
          <td class="cmp-typical" data-mobile-label="A typical firm">Generalist, applied broadly</td>
          <td class="cmp-a2z" data-mobile-label="A2Z Accounting">Specialists in your sector</td>
        </tr>
      </tbody>
    </table>
...
<section class="prof-standing-strip">
  <div class="prof-standing-inner reveal">
    <div class="prof-standing-item" style="display: flex; flex-direction: column; align-items: center; gap: 16px;">
      <div class="prof-standing-icon-wrap">
                        ...
                        <div class="a2zvt__slide">
                            <a href="https://www.loom.com/embed/8761cb23b0a34e558b8867204c69e68f?sid=03ed2529-3243-45c6-a8e8-cfe8dfdfbfdc"
                                data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img"
                                    src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/Testimonial-â€“-a2z-accounting-06-04-2025_12_21_PM-21.png"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In the UK, anyone can legally call themselves an accountant without any qualification. FCCA stands for Fellow of the Association of Chartered Certified Accountants â€” the highest level of ACCA membership, awarded to fewer than 50,000 practitioners worldwide. At A2Z, every piece of work is reviewed to FCCA standard by a Fellow who trained under Big 4 audit standards (Deloitte and EY) before it leaves the firm."
      }
    },
    {
      "@type": "Question",
      "name": "How does A2Z Accounting's fixed fee work â€” what is included?",
      "acceptedAnswer": {
        "@type": "Answer",
...
// Story chain â€” bidirectional dot progress + fire-once text reveal
(function() {
...
// Guarantees â€” scroll-focus highlight (mobile only, bidirectional)
(function() {
...
// Dept pillars â€” hover+auto-shuffle on desktop, click accordion on tablet
(function() {
