  ...
  <div class="hero-inner">
    <div class="hero-left">
      <h1 class="hero-heading reveal d1">
        Most accountants file your returns.<br />
        We run your <em>finance function.</em>
      </h1>
...
<section class="team-quote-band">
  <div class="team-quote-inner">
    <p class="team-quote-main reveal">
      Every client is served by a <em>dedicated<br />team</em> of specialists — not a single generalist.
    </p>
    <p class="team-quote-sub reveal d1">Every piece of work reviewed to <strong>FCCA standard</strong> before it leaves
      the firm.</p>
  </div>
</section>
    ...
    <div class="testimonials-grid">
      <div class="testi-card reveal">
        ...
        <div class="testi-google-badge">
          <svg viewBox="0 0 24 24" fill="none" width="16" height="16" aria-label="Google Review">
            <path
