...
<!-- ═══════════════════════════════════════
   FOUNDER PROFILE (LIGHT THEME)
═══════════════════════════════════════ -->
<style>
.founder-profile-sec {
  background: #ffffff;
  padding: clamp(60px, 8vw, 80px) clamp(24px, 5vw, 72px);
}
...
.founder-profile-img-wrap::after {
  content: '';
  position: absolute;
...
.founder-callout h3 span {
  color: var(--gold);
}

</style>

<section class="founder-profile-sec">
  <div class="founder-profile-grid">
    <div class="founder-profile-img-wrap reveal">
      <img class="founder-profile-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2026/04/srahman.png" alt="Shabbir Rahman" />
    </div>
    
    <div class="founder-profile-content reveal d1">
      <div class="founder-profile-head">
        <span class="founder-profile-label">Founder &amp; Chief Executive</span>
        <h2 class="founder-profile-name">Shabbir Rahman</h2>
        <span class="founder-profile-creds">FCCA &bull; Econ (Hons)</span>
      </div>
      
      <div class="founder-bio-item">
      ...
      <div class="founder-bio-item">
        ...
        <p>Built his corporate finance experience at Subsea 7, a multibillion-pound oil and gas contractor operating across international markets, including a team leadership role.</p>
      </div>
...
<section class="founder-message">
  <div class="founder-message-inner">
    
    <span class="founder-message-label reveal">
      A Message From Our Founder
    </span>

    <div class="founder-prose reveal d1">
    ...
    <div class="founder-callout reveal d2">
      <h3>
