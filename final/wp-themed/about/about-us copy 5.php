...
.team-quote-band {
  background:
    linear-gradient(rgba(7, 20, 33, 0.82), rgba(7, 20, 33, 0.86)),
...
.principles {
  background:
    linear-gradient(150deg, rgba(5, 16, 28, 0.95) 0%, rgba(7, 22, 40, 0.93) 50%, rgba(6, 18, 34, 0.96) 100%),
...
.principles::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 88% 18%,
      rgba(212, 168, 79, 0.28) 0%,
      rgba(212, 168, 79, 0.08) 28%,
      transparent 50%);
  pointer-events: none;
  z-index: 0;
}
...
.principles-list {
  border-top: 1px solid rgba(212, 168, 79, 0.22);
}
...
.guar-panel {
  ...
  align-items: center;
  box-shadow:
    0 2px 18px rgba(2, 8, 20, 0.07),
    0 1px 4px rgba(2, 8, 20, 0.04);
  transition:
...
.guar-panel:hover {
  ...
  box-shadow:
    0 8px 36px rgba(2, 8, 20, 0.11),
    0 2px 6px rgba(2, 8, 20, 0.05);
}
...
.contact {
  background:
    linear-gradient(rgba(7, 20, 33, 0.8), rgba(7, 20, 33, 0.88)),
    ...
    <div class="reviews-head reveal">
      ...
      <div class="reviews-badge">
        ...
        <div class="reviews-badge-google">
          <svg viewBox="0 0 24 24" fill="none" aria-label="Google">
            <path
              d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
              fill="#4285F4" />
            <path
