...
.comparison-head {
  ...
  position: relative;
  overflow: hidden;
  padding: clamp(80px, 11vw, 130px) clamp(24px, 5vw, 72px) clamp(52px, 7vw, 82px);
}

.comparison-head::before {
  content: "";
  position: absolute;
  inset: 0;
...
.cmp-table tbody td {
  padding: clamp(22px, 3vw, 32px) clamp(20px, 2.5vw, 32px);
  vertical-align: top;
...
<section class="team-quote-band">
  <div class="team-quote-inner">
    <p class="team-quote-main reveal">
      Every client is served by a <em>dedicated team</em> of specialist. Not a single generalist.
    </p>
...
<section class="comparison-head">
  <div class="comparison-head-inner reveal">
    <div class="comparison-head-left">
      <h2>
        The differences most firms<br /><em>don&rsquo;t disclose</em>
      </h2>
    </div>
    <div class="comparison-head-right">
      <p>Most accounting firms describe themselves the same way. The differences only become clear once you&rsquo;re already a client &mdash; usually when something goes wrong, or when you notice that nothing proactive has ever happened.</p>
    </div>
  </div>
</section>
