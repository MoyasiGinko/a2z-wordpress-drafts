...
.testi-card:hover {
  background: var(--bg);
  box-shadow: 0 4px 24px rgba(2, 8, 20, 0.06);
}
...
.principle-row {
  display: grid;
  grid-template-columns: clamp(80px, 9vw, 116px) 1fr;
...
.principle-row:hover {
  border-bottom-color: rgba(176, 141, 87, 0.28);
}
...
.principle-row:hover .principle-row-num {
  -webkit-text-stroke-color: rgba(176, 141, 87, 0.75);
}
...
<section class="team-quote-band">
  <div class="team-quote-inner">
    <p class="team-quote-main reveal">
      Every client is served by a <em>dedicated team</em> of specialists — not a single generalist.
    </p>
  ...
  <div class="guar-rows">
    <div class="guar-row reveal">
      ...
      <div class="guar-badge">
        <div class="guar-badge-ring"><svg viewBox="0 0 24 24">
    ...
    <div class="testimonials-grid">
      <div class="testi-card reveal">
        <div class="testi-card-top">
          ...
          <div class="testi-google-badge" aria-label="Google review">
