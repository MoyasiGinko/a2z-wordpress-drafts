...
/* Elegant SVG ribbon deco container */
.a2zh-kinetic-bg {
  position: absolute;
  inset: 0;
  pointer-events: none;
...
<main class="a2zh-home" id="a2zh-home">
  ...
  <section class="a2zh-hero-kinetic" <?php if ($banner_url) : ?>
    ...
    <div class="a2zh-kinetic-bg">
      <div class="a2zh-deco-right" aria-hidden="true">
        <svg viewBox="0 0 500 800" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g opacity="0.8">
            <path d="M 500 0 C 75,145 38,385 152,548 C 268,712 500,762 500,800" fill="none" stroke="url(#flowGradient)" stroke-width="1.4" />
            <path d="M 500 52 C 128,182 92,400 194,558 C 298,716 476,764 476,800" fill="none" stroke="rgba(96,165,250,0.28)" stroke-width="1" />
            <path d="M 500 108 C 188,222 150,415 235,568 C 322,722 452,766 452,800" fill="none" stroke="rgba(212,168,79,0.18)" stroke-width="0.9" />
            <animateTransform attributeName="transform" type="translate" values="0,0; -8,-18; 0,0" dur="13s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
          </g>

          <!-- Animated Energy Line -->
          <path d="M 500 0 C 75,145 38,385 152,548 C 268,712 500,762 500,800" fill="none" stroke="url(#flowGradient)" stroke-width="2.2" stroke-dasharray="85 3000" stroke-linecap="round">
            <animate attributeName="stroke-dashoffset" from="0" to="3085" dur="5s" repeatCount="indefinite" />
          </path>

          <!-- Secondary Energy Line -->
          <path d="M 500 52 C 128,182 92,400 194,558 C 298,716 476,764 476,800" fill="none" stroke="rgba(244,213,141,0.65)" stroke-width="1.4" stroke-dasharray="60 3000" stroke-linecap="round">
