...
/* ════ HERO VIDEO TESTIMONIALS SLIDER ════ */
.a2zh-hero-testimonials {
  position: relative;
  width: 100%;
  max-width: 880px;
  margin: 56px auto 0;
...
.a2zh-hero-testimonials__track {
  display: flex;
  transition: transform 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94);
  will-change: transform;
}

.a2zh-hero-testimonials__slide {
  min-width: 100%;
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: 0;
...
.a2zh-hero-testimonials__media img {
  width: 100%;
  height: 100%;
  object-fit: cover;
  display: block;
...
.a2zh-hero-testimonials__media:hover img {
  transform: scale(1.04);
}

.a2zh-hero-testimonials__play {
  position: absolute;
  top: 50%;
  left: 50%;
  ...
  height: 60px;
  border-radius: 50%;
  background: rgba(45, 147, 212, 0.85);
  display: flex;
  align-items: center;
  justify-content: center;
...
.a2zh-hero-testimonials__play::after {
  content: "";
  display: block;
  width: 0;
  height: 0;
...
.a2zh-hero-testimonials__media:hover .a2zh-hero-testimonials__play {
  background: rgba(45, 147, 212, 1);
  transform: translate(-50%, -50%) scale(1.1);
}

/* ── Content Panel ── */
.a2zh-hero-testimonials__content {
  display: flex;
  flex-direction: column;
...
.a2zh-hero-testimonials__header {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
...
.a2zh-hero-testimonials__eyebrow {
  font-size: 0.68rem;
  font-weight: 700;
  letter-spacing: 0.14em;
  text-transform: uppercase;
...
.a2zh-hero-testimonials__stars {
  color: #f4a900;
  font-size: 1rem;
  letter-spacing: 0.06em;
}

.a2zh-hero-testimonials__quote {
  font-family: var(--serif);
...
/* ── Author Row ── */
.a2zh-hero-testimonials__author {
  display: flex;
  align-items: center;
  gap: 14px;
}

.a2zh-hero-testimonials__avatar {
  width: 44px;
  height: 44px;
  border-radius: 50%;
  background: rgba(45, 147, 212, 0.2);
  display: flex;
  align-items: center;
  justify-content: center;
  flex-shrink: 0;
...
.a2zh-hero-testimonials__avatar svg {
  width: 22px;
  height: 22px;
  fill: rgba(255, 255, 255, 0.5);
}

.a2zh-hero-testimonials__name {
  font-size: 0.95rem;
  font-weight: 700;
  color: #fff;
  line-height: 1.3;
...
/* ── Footer Row (CTA + Controls) ── */
.a2zh-hero-testimonials__footer {
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-top: 24px;
...
.a2zh-hero-testimonials__cta:hover {
  background: var(--blue-lt);
  transform: translateY(-1px);
  color: #fff;
}

.a2zh-hero-testimonials__controls {
  display: flex;
  gap: 8px;
}

.a2zh-hero-testimonials__btn {
  width: 40px;
  height: 40px;
  border-radius: 50%;
...
.a2zh-hero-testimonials__btn:hover {
  border-color: rgba(255, 255, 255, 0.7);
  background: rgba(255, 255, 255, 0.08);
  transform: scale(1.08);
}

.a2zh-hero-testimonials__btn svg {
  width: 16px;
  height: 16px;
  fill: none;
  stroke: currentColor;
  ...
  <?php endif; ?>>
    ...
    <div class="a2zh-wrap">
      <div class="a2zh-kinetic-layout">
        ...
        <div class="a2zh-hero-testimonials a2zh-rv a2zh-d3" id="a2zh-hero-vt">
          <div class="a2zh-hero-testimonials__track" id="a2zh-hero-vt-track">

            <!-- Slide 1 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/8761cb23b0a34e558b8867204c69e68f?sid=03ed2529-3243-45c6-a8e8-cfe8dfdfbfdc" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/Testimonial-–-a2z-accounting-06-04-2025_12_21_PM-21.png" alt="Kevin Smith" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  <div class="a2zh-hero-testimonials__header">
                    <span class="a2zh-hero-testimonials__eyebrow">Trusted by ambitious businesses</span>
                    <span class="a2zh-hero-testimonials__stars">★★★★★</span>
                  </div>
                  <p class="a2zh-hero-testimonials__quote">&ldquo;Building a real relationship with our accountant, not just handing over paperwork like before&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Kevin Smith</div>
                      <div class="a2zh-hero-testimonials__role">Owner, The Drouthy Cobbler – Elgin &amp; Spey Life – Forres</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
                  <button type="button" data-bs-toggle="modal" data-bs-target="#gitModal" class="a2zh-hero-testimonials__cta">Get an instant fee estimate</button>
                  <div class="a2zh-hero-testimonials__controls">
                    <button class="a2zh-hero-testimonials__btn a2zh-hero-vt-prev" type="button" aria-label="Previous testimonial"><svg viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button>
                    <button class="a2zh-hero-testimonials__btn a2zh-hero-vt-next" type="button" aria-label="Next testimonial"><svg viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- Slide 2 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/7878b7d8ae564fb7822bcc706a5efc33?sid=9ba321ad-2b32-47d8-9b10-4c35befedbb4" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/04/testi-img-1.jpg" alt="Mrs. Rona Tonge" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;An absolute pleasure to work with!&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Mrs. Rona Tonge</div>
                      <div class="a2zh-hero-testimonials__role">Managing Director, Golf View Hotel – Lossiemouth</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 3 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/9caff76064d2408c8193cb5406ef69ea?sid=d94dc925-fc5a-4791-9d7f-ec17f8c61099" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/3.png" alt="Mr. Mohamed Ali" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;As they grow, we grow&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Mr. Mohamed Ali</div>
                      <div class="a2zh-hero-testimonials__role">Property Tycoon &amp; Owner, MacAli Hotel Group – Elgin</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 4 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/157bd97bdd42416497aab3ccf8de5843?sid=69be3f94-62e4-4707-a7a1-a62d331a205a" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/4-1024x787.png" alt="Behrouz Abolghassem" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;My business grew stress-free—want a good life? Move to A2Z.&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Behrouz Abolghassem</div>
                      <div class="a2zh-hero-testimonials__role">Owner, Little Italy – St Andrews</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 5 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/6e7d53d784924c84a5240d390cf0e40b?sid=f5faf8ce-1882-4c2d-aaac-6fa91e6cafd4" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/5.png" alt="Christopher O'Halloran" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;The friends I referred to A2Z faced challenges, but those who made the move to A2Z couldn&rsquo;t thank me enough&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Christopher O&rsquo;Halloran</div>
                      <div class="a2zh-hero-testimonials__role">Owner, The Green Inn – Ballater</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 6 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/0f25c7b69a2e4af4bac8d720949df52b?sid=6cca37ba-b380-4659-b3f7-492a6a0c270e" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/6-1024x846.png" alt="Khuram Qadir CEng" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;You really get to know your accountant when you&rsquo;re in the deep end.&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Khuram Qadir CEng</div>
                      <div class="a2zh-hero-testimonials__role">Founder &amp; Oil &amp; Gas Engineer, Cygnas Solutions – Aberdeen</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 7 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/71e4d66232384e49ad4642d862c65f73?sid=1ceca9bb-b0bd-43e7-bf28-ed5a78eae4a3" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/7.png" alt="Mrs. Lisa Morrison" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;Every team member is exceptionally supportive—always quick to assist and resolve&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Mrs. Lisa Morrison</div>
                      <div class="a2zh-hero-testimonials__role">Treasurer, Seaforth Club – Nairn</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 8 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/93fa845584ea405891cbf002857eff90?sid=577353ff-833d-468c-b323-13c2dd81bdc3" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/8.webp" alt="Mr. Hosam Yousef" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;I can trust them to handle everything while I focus on growing my business&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Mr. Hosam Yousef</div>
                      <div class="a2zh-hero-testimonials__role">Pharmacist &amp; Pharmacy Owner – Aberdeen</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 9 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/6a780d36e37a4a308ffcfaa4b5c574d6?sid=8a02ccd9-9067-4a15-873b-8f2acd06dba7" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/9.png" alt="Lesia Robertson" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;A2Z are the most amazing accountants—turning my sleepless nights into clarity and confidence.&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Lesia Robertson</div>
                      <div class="a2zh-hero-testimonials__role">Director, Mamma Mia – Banchory</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 10 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/fd60672b40cf4103a1f5c30f0ddfe884?sid=652f2519-2d2e-4aa2-87a0-22522d95a0bf" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/10.webp" alt="Nurul Hoque Ali" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">Oil &amp; Gas Engineering Consultant – Aberdeen</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Nurul Hoque Ali</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 11 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/13ce4a974d34447baf27484eebf9b93f?sid=c808bb8a-53ed-451c-befb-ce214241f5df" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/11.png" alt="Kimberley Welsh" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;Switching to A2Z has been a game-changer – fast, efficient, and helped improve my knowledge!&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Kimberley Welsh</div>
                      <div class="a2zh-hero-testimonials__role">Owner, Ca&rsquo;dora Diner – Elgin</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 12 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/309b1b0e1364427ab246273db38147ab?sid=6ee63d23-fd48-4854-b0c0-6fe7456a6b20" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/12-1024x859.webp" alt="Ameer Aslam" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;Switched accountants a week before the deadline—A2Z handled everything flawlessly.&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Ameer Aslam</div>
                      <div class="a2zh-hero-testimonials__role">Owner, Nickel &amp; Dime – Various</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 13 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/3e5ec41c4e4c4373bf29d8eee84788cb?sid=68038677-011d-4bb0-994e-34249e4f662a" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/13.png" alt="Ms. Cassandara-Jane Thornton" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;A2Z transformed our chaotic accounts, making the impossible achievable&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Ms. Cassandara-Jane Thornton</div>
                      <div class="a2zh-hero-testimonials__role">Owner, West End Hotel – Nairn</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 14 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/a541d08386e4430f9f24cf73c2d8555b?sid=99e89d9f-52da-4f65-899d-c649c587f5bb" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/14.png" alt="Dr. Hassan Abbas" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;7 years of unwavering support—A2Z navigates VAT complexities and fuels my clinic&rsquo;s growth!&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Dr. Hassan Abbas</div>
                      <div class="a2zh-hero-testimonials__role">Managing Director &amp; Consultant Cardiologist, Hourglass Wellbeing – Aberdeen</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
            ...
            <!-- Slide 15 -->
            <div class="a2zh-hero-testimonials__slide">
              <a href="https://www.loom.com/embed/921fccbea4f843c491d01bcbd43ecb59?sid=6c19fc7e-8e90-4300-ae8b-0dc869a26a81" data-lity class="a2zh-hero-testimonials__media">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/15.png" alt="Hassan Nazer" loading="lazy" />
                <span class="a2zh-hero-testimonials__play"></span>
              </a>
              <div class="a2zh-hero-testimonials__content">
                <div>
                  ...
                  <p class="a2zh-hero-testimonials__quote">&ldquo;They&rsquo;ve got a solution for every problem&rdquo;</p>
                  <div class="a2zh-hero-testimonials__author">
                    <span class="a2zh-hero-testimonials__avatar"><svg viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span>
                    <div>
                      <div class="a2zh-hero-testimonials__name">Hassan Nazer</div>
                      <div class="a2zh-hero-testimonials__role">British Film Director &amp; Entrepreneur – Aberdeen</div>
                    </div>
                  </div>
                </div>
                <div class="a2zh-hero-testimonials__footer">
...
(function() {
  ...
  /* ─── hero video testimonials slider ─── */
  var vtSlider = document.getElementById("a2zh-hero-vt");
  if (vtSlider) {
    var vtTrack = document.getElementById("a2zh-hero-vt-track");
    var vtSlides = vtTrack.querySelectorAll(".a2zh-hero-testimonials__slide");
    var vtCurrent = 0;
    var vtTotal = vtSlides.length;
    var vtAnimating = false;

    var vtGo = function(idx) {
      if (vtAnimating) return;
      vtAnimating = true;
      vtCurrent = ((idx % vtTotal) + vtTotal) % vtTotal;
      vtTrack.style.transform = "translateX(-" + (vtCurrent * 100) + "%)";
      setTimeout(function() { vtAnimating = false; }, 520);
    };

    vtSlider.addEventListener("click", function(e) {
      var prev = e.target.closest(".a2zh-hero-vt-prev");
      var next = e.target.closest(".a2zh-hero-vt-next");
      if (prev) { e.preventDefault(); vtGo(vtCurrent - 1); }
      if (next) { e.preventDefault(); vtGo(vtCurrent + 1); }
    });

    // Auto-advance every 6s, pause on hover
    var vtAutoTimer = null;
    var vtStartAuto = function() {
      vtAutoTimer = setInterval(function() { vtGo(vtCurrent + 1); }, 6000);
    };
    vtSlider.addEventListener("pointerenter", function() { clearInterval(vtAutoTimer); });
    vtSlider.addEventListener("pointerleave", function() { vtStartAuto(); });
    vtStartAuto();
  }
