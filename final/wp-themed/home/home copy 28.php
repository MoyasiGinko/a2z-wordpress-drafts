...
.a2zh-switch-badge-svg {
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
  animation: a2zh-spin 18s linear infinite;
}

.a2zh-switch-badge-svg circle.main-ring {
  fill: transparent;
  transition: fill 0.4s var(--ease);
}

.a2zh-switch-badge:hover .a2zh-switch-badge-svg circle.main-ring {
  fill: rgba(13, 79, 124, 0.15);
}

.a2zh-switch-badge-svg circle.dot {
  transition: fill 0.3s var(--ease);
}

.a2zh-switch-badge:hover .a2zh-switch-badge-svg circle.dot {
  fill: var(--blue-dk);
}

.a2zh-switch-badge-text {
  position: relative;
  width: 65%;
  height: 65%;
  display: flex;
  ...
  box-shadow: 0 12px 30px rgba(13, 79, 124, 0.15), inset 0 0 20px rgba(255, 255, 255, 0.4);
  font-family: var(--serif);
...
.a2zh-switch-badge:hover .a2zh-switch-badge-text {
  transform: scale(1.08);
  box-shadow: 0 18px 40px rgba(13, 79, 124, 0.25), inset 0 0 30px rgba(255, 255, 255, 0.6);
  color: var(--navy-deep);
}
...
.a2zh-cta::before {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 80% 50%, rgba(45, 147, 212, 0.35) 0%, transparent 60%),
    radial-gradient(circle at 10% 80%, rgba(26, 111, 168, 0.15) 0%, transparent 60%);
  pointer-events: none;
}
...
.a2zh-contact-stack {
  display: flex;
  flex-direction: column;
  background: linear-gradient(100deg, rgba(230, 230, 230, 0.08) 0%, rgba(143, 214, 244, 0.15) 50%, rgba(230, 230, 230, 0.08) 100%);
  background-size: 200% auto;
  animation: a2zh-shine 8s linear infinite;
...
.a2zh-contact-stack:hover {
  border-color: rgba(45, 147, 212, 0.35);
  box-shadow: 0 40px 80px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(45, 147, 212, 0.15);
}
  ...
  <section class="a2zh-section">
    <div class="a2zh-wrap">
      <div class="a2zh-path" id="a2zhPath">
        ...
        <div class="a2zh-switch-badge">
          <svg viewBox="-10 -10 120 120" class="a2zh-switch-badge-svg" aria-hidden="true">
            <circle class="main-ring" cx="50" cy="50" r="46" fill="transparent" stroke="var(--blue-dk)" stroke-width="5" />
            <circle class="dot" cx="50" cy="4" r="7" fill="transparent" stroke="var(--blue-dk)" stroke-width="3" />
            <circle class="dot" cx="89.8" cy="73" r="7" fill="transparent" stroke="var(--blue-dk)" stroke-width="3" />
            <circle class="dot" cx="10.2" cy="73" r="7" fill="transparent" stroke="var(--blue-dk)" stroke-width="3" />
          </svg>
          <div class="a2zh-switch-badge-text">SWITCH</div>
        </div>
      </div>
    </div>
  </section>
