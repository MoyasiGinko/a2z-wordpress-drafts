...
.a2zh-card:hover {
  ...
  box-shadow: 0 18px 44px rgba(12, 39, 66, 0.16);
}
...
<main class="a2zh-home" id="a2zh-home">
  ...
  <section class="a2zh-section">
    <div class="a2zh-wrap">
      <div class="a2zh-split a2zh-split--rev">
        <div class="a2zh-photo-stack a2zh-rv">
          <figure><img
              src="<?php echo $switching_img_1 ? esc_url($switching_img_1['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/08/switch-1.webp'; ?>"
              alt="Moving to A2Z Accounting structured onboarding" loading="lazy" /></figure>
          <figure><img
              src="<?php echo $switching_img_2 ? esc_url($switching_img_2['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/08/switch-2.webp'; ?>"
              alt="A2Z Accounting client partnership built on trust" loading="lazy" /></figure>
          <figure><img
              src="<?php echo $switching_img_3 ? esc_url($switching_img_3['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/08/switch-3.webp'; ?>"
              alt="A2Z Accounting professional specialist team" loading="lazy" /></figure>
        </div>
        <div>
          <span class="a2zh-label a2zh-rv">Moving to A2Z</span>
          <h2 class="a2zh-title a2zh-rv a2zh-d1">
          ...
          <div class="a2zh-steps a2zh-rv a2zh-d2">
            <?php foreach ($switch_steps as $i => $st) : ?>
            <div class="a2zh-step"><span class="a2zh-step-num"><?php echo sprintf('%02d', $i + 1); ?></span>
              <div><strong><?php echo $st[0]; ?></strong><span><?php echo $st[1]; ?></span></div>
            </div>
            <?php endforeach; ?>
          </div>
          <div class="a2zh-actions a2zh-rv">
