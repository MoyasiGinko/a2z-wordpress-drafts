...
.a2zh-switching-simple {
    ...
    background: radial-gradient(circle at 50% 0%, #fff 0%, #f3ede0 100%);
...
.a2zh-pricing-card {
    position: relative;
    background: linear-gradient(180deg, rgba(2, 28, 63, 0.93) 0%, rgba(41, 35, 5, 0.92) 100%);
...
@media (max-width: 1024px) {
    ...
    .a2zh-pricing-addon-item:last-child { border-bottom: none; }
    .a2zh-pricing-addon-chevron-wrap {
        width: 100%;
        height: 30px;
        flex-direction: row;
        ...
        <div class="a2zh-wrap">
            <div class="a2zh-price-guarantee-inner a2zh-rv">
                ...
                <h2 class="a2zh-title a2zh-price-guarantee-title">
                    One fixed monthly price. No surprise bills. <span>Guaranteed.</span>
                </h2>
                ...
                <div class="a2zh-actions" style="justify-content: center;">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#enquireModal" data-source="Get a fee estimate" class="a2zh-btn a2zh-btn--solid" style="box-shadow: 0 0 40px rgba(212, 168, 79, 0.35); text-transform: uppercase; font-size: 0.95rem; font-weight: 700; padding: 18px 40px;">GET A FEE ESTIMATE</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="a2zh-wrap">
            ...
            <div class="a2zh-switching-grid a2zh-rv">
                ...
                <div class="a2zh-switching-step">
                    ...
                    <div class="a2zh-switching-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16M15 2l5 5-5 5M20 17H4M9 22l-5-5 5-5"/></svg>
                    </div>
                ...
                <div class="a2zh-switching-step">
                    ...
                    <div class="a2zh-switching-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>
                    </div>
            ...
            <div class="a2zh-cta-split">
                <div>
                    ...
                    <div class="a2zh-actions a2zh-rv a2zh-d2">
                        <?php if ($focus_btn) : ?>
                        <button type="button" data-source="<?php echo esc_attr($quote_btn_title); ?>"
                            data-bs-toggle="modal" data-bs-target="<?php echo $quote_modal_target; ?>"
                        ...
                        <button type="button" data-source="Get an instant fee estimate" data-bs-toggle="modal"
                            data-bs-target="<?php echo $quote_modal_target; ?>" class="a2zh-btn a2zh-btn--soft">Get an
                            instant fee
                            estimate</button>
                        <?php endif; ?>
                ...
                <div class="a2zh-contact-stack a2zh-rv a2zh-d1">
                    <div class="a2zh-contact-card"><span>Call us directly</span><a href="tel:01224042961">01224
                            042961</a></div>
                    ...
                    <div class="a2zh-contact-card"><span>Office</span><strong>1st Floor, 499 Union Street, Aberdeen AB11
                            6DB</strong></div>
                    <div class="a2zh-contact-card"><span>Client portal</span><a href="https://login.engager.app/"
                            target="_blank" rel="noopener">Login to your portal</a></div>
                </div>
            </div>
        ...
        <div class="a2zh-wrap">
            <div class="a2zh-split a2zh-split--rev">
                <figure class="a2zh-media a2zh-media--wide a2zh-rv">
                    <img src="<?php echo $download_img ? esc_url($download_img['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/04/download_img1.png'; ?>"
