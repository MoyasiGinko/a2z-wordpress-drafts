...
.a2zh-card.a2zh-sector {
  ...
  box-shadow: 0 8px 26px rgba(2, 8, 20, 0.3) !important;
  backdrop-filter: none !important;
  -webkit-backdrop-filter: none !important;
}

.a2zh-card.a2zh-sector::after {
  display: block !important;
  content: "";
  position: absolute;
  inset: 0;
  background: rgba(7, 20, 33, 0.75) !important;
  backdrop-filter: blur(12px) saturate(1.2) !important;
  -webkit-backdrop-filter: blur(12px) saturate(1.2) !important;
  z-index: -1 !important;
  transition: background 0.4s var(--ease), backdrop-filter 0.4s var(--ease), -webkit-backdrop-filter 0.4s var(--ease) !important;
  left: 0 !important;
  width: 100% !important;
...
.a2zh-card.a2zh-sector:hover {
  background-color: transparent !important;
  background-image: var(--bg-img) !important;
  border-color: rgba(212, 168, 79, 0.55) !important;
  box-shadow: 0 30px 64px rgba(8, 29, 51, 0.4), 0 0 0 1px rgba(212, 168, 79, 0.18) !important;
}

.a2zh-card.a2zh-sector:hover::after {
  background: rgba(7, 20, 33, 0.3) !important;
      ...
      <div class="a2zh-sectors">
        ...
        if (have_rows('we_help_repeater')) :
          while (have_rows('we_help_repeater')) : the_row();
            ...
            $style = $bg_url ? 'style="--bg-img: url(\'' . esc_url($bg_url) . '\');"' : 'style="--bg-img: none;"';
        ?>
        <a class="a2zh-card a2zh-sector a2zh-rv" href="<?php echo esc_url($link_url); ?>" <?php echo $style; ?>>
          <h3><?php echo get_sub_field('title'); ?></h3>
          <p><?php echo get_sub_field('content'); ?></p>
        ...
        <?php
          ...
          foreach ($sectors_default as $sc) :
            ...
            $style = $bg_url ? 'style="--bg-img: url(\'' . esc_url($bg_url) . '\');"' : 'style="--bg-img: none;"';
        ?>
        <a class="a2zh-card a2zh-sector a2zh-rv" href="<?php echo esc_url($sc[2]); ?>" <?php echo $style; ?>>
          <h3><?php echo $sc[0]; ?></h3>
          <p><?php echo $sc[1]; ?></p>
          <span class="a2zh-sector-link">Explore</span>
        </a>
