...
<main class="a2zh-home" id="a2zh-home">
  ...
  ?>
  <section class="a2zh-hero" <?php if ($banner_url) : ?>
    style="background-image: linear-gradient(180deg, rgba(232,243,251,0.82) 0%, rgba(244,249,252,0.9) 100%), url('<?php echo esc_url($banner_url); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
    <?php endif; ?>>
    <div class="a2zh-wrap">
