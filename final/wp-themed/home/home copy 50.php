        ...
        <div class="a2zh-wrap">
            ...
            <div class="a2zh-hub" id="a2zhHub">
                ...
                <div class="a2zh-hub-center">
                    <figure class="a2zh-hub-media">
                        <img src="<?php echo $our_promise_img ? esc_url($our_promise_img['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/04/promise-img.jpg'; ?>"
                            alt="A2Z Accounting higher standard of financial management for UK businesses"
                            loading="lazy" />
                    </figure>
            ...
            <div class="a2zh-promise-foot a2zh-rv">
                ...
                <div class="a2zh-actions">
                    <button type="button" data-source="<?php echo esc_attr($promise_btn_title); ?>"
                        data-bs-toggle="modal" data-bs-target="#enquireModal"
