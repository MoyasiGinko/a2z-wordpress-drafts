...
/* ════ JOURNEY (image paired with its detail, staggered) ════ */
.a2zh-journey-head {
  max-width: 60ch;
...
/* scatter the three across the section */
.a2zh-journey-item:nth-child(2) {
  margin-top: clamp(30px, 6vw, 72px);
}

.a2zh-journey-item:nth-child(3) {
  margin-top: clamp(60px, 11vw, 132px);
}
...
.a2zh-journey-item:hover .a2zh-journey-media img {
...
<main class="a2zh-home" id="a2zh-home">
  ...
  <section class="a2zh-section">
    <div class="a2zh-wrap">
      ...
      <div class="a2zh-journey-grid">
        <?php foreach ($switch_steps as $i => $st) : ?>
        <article class="a2zh-card a2zh-journey-item a2zh-rv a2zh-d<?php echo $i + 1; ?>">
          <figure class="a2zh-journey-media">
            <img src="<?php echo $switch_imgs[$i]; ?>" alt="<?php echo esc_attr($st[0]); ?>" loading="lazy" />
          </figure>
          <div class="a2zh-journey-body">
