...
.a2zh-who-item:hover {
  background: linear-gradient(135deg, rgba(212, 168, 79, 0.22), rgba(212, 168, 79, 0.12));
  -webkit-backdrop-filter: blur(10px) saturate(1.5);
  backdrop-filter: blur(10px) saturate(1.5);
  border-color: rgba(212, 168, 79, 0.55);
  box-shadow: 0 18px 40px rgba(212, 168, 79, 0.18);
...
.a2zh-tcard-play i {
  ...
  height: 52px;
  border-radius: 999px;
  background: rgba(212, 168, 79, 0.82);
  color: #fff;
  display: flex;
  align-items: center;
  justify-content: center;
...
.a2zh-tm-card:hover .a2zh-tm-play {
  background: rgba(212, 168, 79, 0.6);
}
...
.a2zh-cta::before {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 80% 50%, rgba(212, 168, 79, 0.4) 0%, transparent 55%),
    radial-gradient(circle at 10% 80%, rgba(212, 168, 79, 0.25) 0%, transparent 60%);
  pointer-events: none;
...
<main class="a2zh-home" id="a2zh-home">
  ...
  <section class="a2zh-hero-kinetic" <?php if ($banner_url) : ?>
    style="background-image: linear-gradient(180deg, rgba(7,20,33,0.95) 0%, rgba(7,20,33,0.5) 40%, rgba(7,20,33,0) 100%), linear-gradient(0deg, rgba(253,253,253,1) 0%, rgba(253,253,253,0) 100%), url('<?php echo esc_url($banner_url); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
    <?php endif; ?>>
