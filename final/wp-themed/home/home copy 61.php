...
$sectors_default = [
  ...
  ['Social Media &amp; Influencers', 'Content Creators, YouTubers, Bloggers, Podcasters, Digital Marketers', '/help/social-media-influencers/', 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&w=800&q=80'],
  ...
  ['Oil &amp; Gas and Engineering',  'Companies, Engineers, Contractors, IT, Energy Consultancies, Oilfield Services, Renewables', '/help/oil-gas-and-engineering/', 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=800&q=80'],
];
...
/* Subtle radial glows referencing about-us.php */
.a2zh-hero-kinetic::before {
    content: "";
    position: absolute;
    top: 10%;
    left: -12%;
...
/* Elegant SVG Growth Curves background */
.a2zh-kinetic-bg {
    position: absolute;
    inset: 0;
    pointer-events: none;
...
.a2zh-btn--kinetic-ghost {
    ...
    border: 3px solid rgba(212, 168, 79, 0.7);
    border-radius: 100px;
    background: transparent;
    display: inline-flex;
    align-items: center;
...
/* ════ SWITCHING SIMPLE ════ */
.a2zh-switching-simple {
    background-color: #ffffffff;
    background: radial-gradient(circle at 50% 0%, #fff 0%, #ffffffff 100%);
    padding: clamp(80px, 10vw, 120px) 20px;
    text-align: center;
}

.a2zh-switching-simple-title {
...
.a2zh-switching-simple-title span {
    color: #c49a56;
}
...
.a2zh-switching-arrow--1 {
    left: calc(33.333% - 24px);
    animation: slideRightFade 2.5s infinite ease-in-out;
}
.a2zh-switching-arrow--2 {
    left: calc(66.666% - 24px);
    animation: slideRightFade 2.5s infinite ease-in-out 1.25s;
}
...
@media (max-width: 768px) {
    ...
    .a2zh-switching-step:hover {
        transform: none !important;
        background: rgba(255, 255, 255, 0.4) !important;
        border-color: rgba(255, 255, 255, 0.8) !important;
        box-shadow: 0 10px 30px rgba(0, 0, 0, 0.02) !important;
    }
    .a2zh-switching-step:hover .a2zh-switching-icon {
        transform: none !important;
    }
    .a2zh-switching-step:hover .a2zh-switching-icon::after {
        transform: none !important;
        background: #e6dfcc !important;
    }
}
...
.a2zh-switching-image {
    width: 100%;
    height: 220px;
    object-fit: cover;
    border-radius: 16px;
    margin-bottom: -48px;
    box-shadow: 0 10px 30px rgba(11, 26, 42, 0.1);
    position: relative;
    z-index: 0;
}
...
.a2zh-switching-step:hover {
    ...
    box-shadow: 0 20px 40px rgba(11, 26, 42, 0.08);
}
...
/* The soft cream halo around the dark circle */
.a2zh-switching-icon::after {
    content: "";
    position: absolute;
    inset: -12px;
    border-radius: 50%;
...
.a2zh-switching-step p {
    font-size: 1.15rem;
    font-weight: 500;
    line-height: 1.65;
    color: rgba(11, 26, 42, 0.95);
    max-width: 320px;
    margin: 0 auto;
}

.a2zh-switching-actions {
...
/* ════ PRICING TIERS ════ */
@keyframes a2zh-chevron-pulse {
    0%   { opacity: 0;    transform: translateX(-6px); }
    40%  { opacity: 1;    transform: translateX(0px); }
    80%  { opacity: 0.2;  transform: translateX(6px); }
...
.a2zh-pricing-card {
    position: relative;
    background: linear-gradient(180deg, rgba(2, 28, 63, 0.93) 0%, rgba(4, 4, 0, 0.92) 100%);
...
.a2zh-pricing-card:hover {
    transform: translateY(-8px);
    box-shadow: 0 30px 60px rgba(7, 20, 33, 0.5), 0 0 30px rgba(212, 168, 79, 0.15);
    border-color: rgba(212, 168, 79, 0.4);
}

/* ── HEADER ── */
.a2zh-pricing-card-header {
...
/* animated gold line decoration */
.a2zh-pricing-card-header::after {
    content: "";
    position: absolute;
    bottom: -1px; left: 0;
    width: 60px; height: 2px;
    background: linear-gradient(90deg, rgba(212, 168, 79, 0.8), transparent);
    transition: width 0.5s cubic-bezier(0.16, 1, 0.3, 1);
}

.a2zh-pricing-card:hover .a2zh-pricing-card-header::after {
    width: 100%;
}

.a2zh-pricing-card-header h3 {
    font-family: var(--serif);
...
/* ══════════════════════════════════════
   PREMIER CARD — special edition
══════════════════════════════════════ */
.a2zh-pricing-card--premier {
    background: linear-gradient(160deg, rgba(0, 46, 106, 0.99) 0%, rgba(18, 14, 6, 0.97) 100%);
    border-right: none;
    box-shadow: inset 0 0 80px rgba(212, 168, 79, 0.06);
}



/* animated gold shimmer sweep */
.a2zh-pricing-card--premier::after {
    content: "";
    position: absolute;
    inset: 0;
    background: linear-gradient(115deg, transparent 30%, rgba(212, 168, 79, 0.07) 50%, transparent 70%);
    background-size: 200% 100%;
    animation: a2zh-premier-shimmer 4s linear infinite;
    pointer-events: none;
}

@keyframes a2zh-premier-shimmer {
    0%   { background-position: 200% 0; }
    100% { background-position: -200% 0; }
}

/* premier header styling */
.a2zh-pricing-card--premier .a2zh-pricing-card-header {
    position: relative;
...
.a2zh-pricing-card--premier .a2zh-pricing-card-header h3 {
    color: #f0d080;
    text-shadow: 0 0 30px rgba(212, 168, 79, 0.3);
}

.a2zh-pricing-card--premier .a2zh-pricing-card-body p {
...
.a2zh-pricing-badge {
    ...
    gap: 6px;
    margin-top: 12px;
    background: linear-gradient(135deg, rgba(212, 168, 79, 0.2), rgba(212, 168, 79, 0.08));
    ...
    padding: 5px 12px;
    width: fit-content;
    box-shadow: 0 0 16px rgba(212, 168, 79, 0.2);
    z-index: 3;
}

.a2zh-pricing-badge::before {
    content: "★";
    font-size: 0.55rem;
    color: #d4a84f;
}
...
.a2zh-pricing-addon {
    position: relative;
    background: linear-gradient(160deg, #050f1ced 0%, #211907fa 100%);
    border: 1px solid rgba(212, 168, 79, 0.15);
    border-top: 2px solid rgba(212, 168, 79, 0.3);
    border-radius: 20px;
    padding: clamp(40px, 5vw, 60px);
    overflow: hidden;
}

/* large faint gold radial bg glow */
.a2zh-pricing-addon::before {
    content: "";
    position: absolute;
    top: -100px; left: 50%;
    transform: translateX(-50%);
    width: 600px; height: 300px;
    background: radial-gradient(ellipse, rgba(212, 168, 79, 0.08), transparent 70%);
    pointer-events: none;
}

/* thin animated line at top */
.a2zh-pricing-addon::after {
    content: "";
    position: absolute;
    top: -2px; left: 0; right: 0;
    height: 1px;
    background: linear-gradient(90deg, transparent 0%, rgba(212, 168, 79, 0.8) 40%, rgba(212, 168, 79, 0.8) 60%, transparent 100%);
}

.a2zh-pricing-addon-head {
    text-align: center;
    margin-bottom: 48px;
    position: relative;
    z-index: 2;
...
.a2zh-pricing-addon-item:hover {
    background: rgba(212, 168, 79, 0.04);
    border-color: rgba(212, 168, 79, 0.5);
    box-shadow: 0 10px 30px rgba(7, 20, 33, 0.5), 0 0 20px rgba(212, 168, 79, 0.1);
    transform: translateY(-4px);
}

/* step number */
.a2zh-pricing-addon-item::before {
    content: attr(data-step);
    display: block;
    margin-bottom: 12px;
    font-size: 2.5rem;
    font-family: var(--serif);
    color: rgba(212, 168, 79, 0.3);
    line-height: 1;
    font-weight: 700;
    transition: color 0.3s ease;
}

.a2zh-pricing-addon-item:hover::before {
    color: rgba(212, 168, 79, 0.8);
}

.a2zh-pricing-addon-item h4 {
    font-size: 1.2rem;
    color: #d4a84f;
    margin: 0 0 14px 0;
    font-weight: 600;
...
/* ── ANIMATED CHEVRON ── */
.a2zh-pricing-addon-chevron-wrap {
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
.a2zh-pricing-addon-chevron {
    position: absolute;
    width: 16px;
    height: 16px;
    color: #d4a84f;
    flex-shrink: 0;
    animation: a2zh-chevron-pulse 1.6s ease-in-out infinite;
}

.a2zh-pricing-addon-chevron:nth-child(2) {
    animation-delay: 0.35s;
    opacity: 0.5;
}

.a2zh-pricing-addon-chevron:nth-child(3) {
...
@media (max-width: 1024px) {
    ...
    .a2zh-pricing-card:last-child { border-bottom: none; }
    .a2zh-pricing-card--premier { border-right: none; }
    .a2zh-pricing-badge {
        position: static;
        transform: none;
        margin-bottom: 14px;
    ...
    .a2zh-pricing-addon-chevron {
        ...
        animation-name: a2zh-chevron-pulse-down;
    }
    @keyframes a2zh-chevron-pulse-down {
        0%   { opacity: 0;   transform: rotate(90deg) translateX(-6px); }
        40%  { opacity: 1;   transform: rotate(90deg) translateX(0px); }
        80%  { opacity: 0.2; transform: rotate(90deg) translateX(6px); }
...
.a2zh-tax-expertise {
    background:
        linear-gradient(150deg, rgba(16, 34, 53, 0.88) 0%, rgba(10, 26, 41, 0.86) 55%, rgba(7, 20, 33, 0.92) 100%),
...
.a2zh-tax-expertise::before {
    content: "";
    position: absolute;
    inset: 0;
    pointer-events: none;
    background:
        radial-gradient(ellipse at 10% 6%, rgba(212, 168, 79, 0.28) 0%, transparent 46%),
        radial-gradient(ellipse at 94% 98%, rgba(212, 168, 79, 0.25) 0%, transparent 52%);
    z-index: 0;
}

.a2zh-tax-expertise .a2zh-wrap {
    position: relative;
    z-index: 1;
}

.a2zh-tax-expertise-head {
    position: relative;
    text-align: center;
    max-width: 90ch;
...
.a2zh-tax-card {
    background: linear-gradient(135deg, rgba(30, 50, 75, 0.4) 0%, rgba(10, 26, 41, 0.8) 100%);
    border: 1px solid transparent;
    border-radius: 20px;
    padding: 48px 40px;
    transition: transform 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), border-color 0.4s ease, box-shadow 0.4s ease, background 0.4s ease;
    box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.05), 0 15px 35px rgba(0, 0, 0, 0.3);
...
.a2zh-tax-card:hover {
    ...
    box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.1), 0 25px 50px rgba(0, 0, 0, 0.5);
    transform: translateY(-6px);
    background: linear-gradient(135deg, rgba(35, 55, 80, 0.5) 0%, rgba(10, 26, 41, 0.85) 100%);
}
...
@media (max-width: 768px) {
    ...
    .a2zh-sector:hover .a2zh-sector-body {
        background: rgba(7, 20, 33, 0.85);
    }
}

/* ════ PRICE GUARANTEE CTA BANNER ════ */
.a2zh-price-guarantee {
    background:
        linear-gradient(150deg, rgba(11, 26, 42, 0.92) 0%, rgba(7, 20, 33, 0.90) 55%, rgba(4, 12, 20, 0.95) 100%),
...
.a2zh-price-guarantee::before {
    content: "";
    position: absolute;
    inset: 0;
    pointer-events: none;
    background: radial-gradient(ellipse at 50% 50%, rgba(212, 168, 79, 0.15) 0%, transparent 60%);
    z-index: 0;
}

.a2zh-price-guarantee-inner {
    position: relative;
    z-index: 1;
    max-width: 800px;
    margin: 0 auto;
...
.a2zh-price-guarantee-title span {
    display: inline;
    background: linear-gradient(100deg, var(--cyan) 0%, #fff 50%, var(--cyan) 100%);
    background-size: 200% auto;
    -webkit-background-clip: text;
...
.a2zvt__thumb {
    ...
    text-decoration: none;
    overflow: hidden;
    padding: clamp(8px, 1.5vw, 16px); /* Reduced padding for a larger image */
    align-self: center; /* Prevents stretching, keeping it strictly rectangular */
}

.a2zvt__thumb-img {
    display: block;
    width: 100%;
    aspect-ratio: 3 / 2; /* Taller and wider relative aspect ratio */
    object-fit: cover;
...
@media (max-width: 900px) {
    ...
    .a2zvt__thumb {
        height: auto;
        padding: clamp(16px, 4vw, 24px); /* Ensure there is visible padding around the rounded image on mobile */
    }
...
<main class="a2zh-home" id="a2zh-home">
  ...
  ?>
    <section class="a2zh-hero-kinetic" <?php if ($banner_url) : ?>
        ...
        <div class="a2zh-kinetic-bg">
            <svg class="a2zh-growth-curves" viewBox="0 0 1440 800" preserveAspectRatio="xMidYMid slice"
                xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="curveGrad1" x1="0%" y1="100%" x2="100%" y2="0%">
                        <stop offset="0%" stop-color="rgba(37,99,235,0)" />
                        <stop offset="40%" stop-color="rgba(37,99,235,0.25)" />
                        <stop offset="80%" stop-color="rgba(212,168,79,0.7)" />
                        <stop offset="100%" stop-color="rgba(244,213,141,1)" />
                    </linearGradient>

                    <linearGradient id="curveGrad2" x1="0%" y1="100%" x2="100%" y2="0%">
                        <stop offset="0%" stop-color="rgba(212,168,79,0)" />
                        <stop offset="50%" stop-color="rgba(212,168,79,0.3)" />
                        <stop offset="100%" stop-color="rgba(255,255,255,0.8)" />
                    </linearGradient>

                    <linearGradient id="curveGrad3" x1="0%" y1="100%" x2="100%" y2="0%">
                        <stop offset="0%" stop-color="rgba(96,165,250,0)" />
                        <stop offset="60%" stop-color="rgba(37,99,235,0.4)" />
                        <stop offset="100%" stop-color="rgba(212,168,79,0.5)" />
                    </linearGradient>
                ...
                <g opacity="0.8">
                    ...
                    <path d="M-100,850 C300,800 600,400 1540,-50" fill="none" stroke="rgba(255,255,255,0.03)"
                        stroke-width="1" />
                    <path d="M-100,950 C400,850 700,300 1540,100" fill="none" stroke="rgba(212,168,79,0.04)"
                        stroke-width="2" />
                    <path d="M-100,1050 C500,900 800,200 1540,250" fill="none" stroke="rgba(37,99,235,0.04)"
                        stroke-width="1.5" />

                    <!-- Animated glowing paths flowing bottom-left to top-right -->
                    <!-- Path 1 Primary (Fast, bright gold/blue) -->
                    <path d="M-100,850 C300,800 600,400 1540,-50" fill="none" stroke="url(#curveGrad1)"
                        stroke-width="3.5" stroke-dasharray="250 3000" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3250" to="0" dur="9s"
                            repeatCount="indefinite" />
                    </path>

                    <!-- Path 1 Secondary (Short bright flash) -->
                    <path d="M-100,850 C300,800 600,400 1540,-50" fill="none" stroke="#fff" stroke-width="1.5"
                        stroke-dasharray="40 3210" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3250" to="0" dur="9s" begin="3s"
                            repeatCount="indefinite" />
                    </path>

                    <!-- Path 2 Primary (Slower, white/gold) -->
                    <path d="M-100,950 C400,850 700,300 1540,100" fill="none" stroke="url(#curveGrad2)" stroke-width="2"
                        stroke-dasharray="150 3200" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3350" to="0" dur="13s" begin="2.5s"
                            repeatCount="indefinite" />
                    </path>

                    <!-- Path 2 Secondary (Long gold sweep) -->
                    <path d="M-100,950 C400,850 700,300 1540,100" fill="none" stroke="rgba(244,213,141,0.8)"
                        stroke-width="3" stroke-dasharray="400 2950" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3350" to="0" dur="15s" begin="0.5s"
                            repeatCount="indefinite" />
                    </path>

                    <!-- Path 3 Primary (Slowest, deep blue/gold) -->
                    <path d="M-100,1050 C500,900 800,200 1540,250" fill="none" stroke="url(#curveGrad3)"
                        stroke-width="4" stroke-dasharray="350 3500" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3850" to="0" dur="17s" begin="1s"
                            repeatCount="indefinite" />
                    </path>

                    <!-- Path 3 Secondary (Quick pulse) -->
                    <path d="M-100,1050 C500,900 800,200 1540,250" fill="none" stroke="rgba(96,165,250,0.6)"
                        stroke-width="2" stroke-dasharray="80 3770" stroke-linecap="round" filter="url(#glowBlur)">
                        <animate attributeName="stroke-dashoffset" from="3850" to="0" dur="11s" begin="5s"
                            repeatCount="indefinite" />
                    </path>
                </g>
            </svg>
            ...
            <div class="a2zh-kinetic-layout">
                ...
                <div class="a2zh-kinetic-content">
                    ...
                    <p class="a2zh-kinetic-sub a2zh-rv a2zh-d3">
                        <?php echo $hero_sub ? esc_html(wp_strip_all_tags($hero_sub)) : 'FCCA-Chartered Certified Accountants for growing UK businesses.'; ?>
                    </p>
                    <!-- <div class="a2zh-hero-rotator a2zh-rv a2zh-d3" id="a2zh-hero-rotator">
                        <span class="a2zh-hero-rotator-line is-active">Chartered Accountants for High Growth Business
                            Owners</span>
                    ...
                    <div class="a2zh-kinetic-actions a2zh-rv a2zh-d3">
                        <a class="a2zh-btn a2zh-btn--kinetic-primary"
                           href="<?php echo esc_url($btn_1_url); ?>"
                           data-source="<?php echo esc_attr($btn_1_title); ?>"
                           data-bs-toggle="modal"
                           data-bs-target="#gitModal">
                        ...
                        <a class="a2zh-btn a2zh-btn--kinetic-ghost"
                           href="<?php echo esc_url($btn_2_url); ?>"
                           data-source="<?php echo esc_attr($btn_2_title); ?>"
                           data-bs-toggle="modal"
                    ...
                    <div class="a2zvt__track" id="a2zvt-track">
                        ...
                        <div class="a2zvt__slide">
                            ...
                            <div class="a2zvt__body">
                                ...
                                <div class="a2zvt__controls"><a href="/testimonial/" class="a2zvt__counter">Watch client
                                        stories</a>
                                    <div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button"
                                            ...
                                            </svg></button><button class="a2zvt__arrow a2zvt-next" type="button"
                                            aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24">
    ...
    <section class="a2zh-section a2zh-pods-sec">
        <div class="a2zh-wrap">
            <div class="a2zh-head">
                ...
                <p class="a2zh-copy a2zh-head-copy a2zh-rv a2zh-d2">The firm is built around proactive planning,
                    reliable
                    communication, and layered review. That structure is what lets growing businesses make decisions
                    with
                    confidence.</p>
            </div>
        ...
        $pod_svgs = [
          '<svg class="a2zh-feature-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>',
          '<svg class="a2zh-feature-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',
          '<svg class="a2zh-feature-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="m9 12 2 2 4-4"/></svg>'
        ];
        ...
        if (have_rows('threepods_repeater')) :
          ...
          while (have_rows('threepods_repeater')) : the_row();
            ...
            $svg = isset($pod_svgs[$i]) ? $pod_svgs[$i] : $pod_svgs[0];
            $i++;
        ?>
  ...
  ?>
    <section class="a2zh-section a2zh-section--tint a2zh-who">
        <div class="a2zh-wrap">
            <div class="a2zh-pricing">
                <h2 class="a2zh-title a2zh-pricing-head a2zh-rv">Three levels of support. <br/> <em>One standard of quality.</em></h2>
                
                <div class="a2zh-pricing-tiers">
                    <!-- Tier 1 -->
                    <div class="a2zh-pricing-card a2zh-rv a2zh-d1">
                        <div class="a2zh-pricing-card-header">
                            <h3>Foundational <br/>Compliance</h3>
                        </div>
                        <div class="a2zh-pricing-card-body">
                            <span class="a2zh-pricing-sub">Small, Steady Companies</span>
                            <p>Everything you must get right: year-end accounts, corporation tax, confirmation statement and HMRC deadlines, all done properly and on time.</p>
                        </div>
                    </div>
                    
                    <!-- Tier 2 -->
                    <div class="a2zh-pricing-card a2zh-rv a2zh-d2">
                        <div class="a2zh-pricing-card-header">
                            <h3>Structured <br/>Oversight</h3>
                        </div>
                        <div class="a2zh-pricing-card-body">
                            <span class="a2zh-pricing-sub">Growing, VAT-Registered</span>
                            <p>Everything in Foundational, plus quarterly bookkeeping and VAT, cloud software included, tax estimates and planning, and same-day support.</p>
                        </div>
                    </div>
                    
                    <!-- Tier 3 (Premier) -->
                    <div class="a2zh-pricing-card a2zh-pricing-card--premier a2zh-rv a2zh-d3">
                        <div class="a2zh-pricing-card-header">
                            <h3>Strategic Partnership</h3>
                            <span class="a2zh-pricing-badge">Premier</span>
                        </div>
                        <div class="a2zh-pricing-card-body">
                            <span class="a2zh-pricing-sub">Established & Complex</span>
                            <p>A full finance function: quarterly management accounts, proactive monthly tax planning, cash flow forecasting, advisory and a dedicated manager.</p>
                        </div>
                    </div>
                </div>

                <!-- Optional Add-on Block -->
                <div class="a2zh-pricing-addon a2zh-rv a2zh-d4">
                    <div class="a2zh-pricing-addon-head">
                        <span class="a2zh-pricing-eyebrow">Optional Add-on &mdash; Each level includes the one before</span>
                        <h3>Quarterly management accounts</h3>
                    </div>
                    <div class="a2zh-pricing-addon-grid">
                        <div class="a2zh-pricing-addon-item" data-step="01">
                            <h4>Financial Health Check</h4>
                            <p>Your profit, cash and tax position, your outstanding tax liabilities and your year-to-date tax estimate. You always know where you stand.</p>
                        </div>
                        <div class="a2zh-pricing-addon-chevron-wrap">
                            <svg class="a2zh-pricing-addon-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                            <svg class="a2zh-pricing-addon-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                            <svg class="a2zh-pricing-addon-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                        </div>
                        <div class="a2zh-pricing-addon-item" data-step="02">
                            <h4>Business Performance</h4>
                            <p>Everything above, plus margins, trends and KPIs, so you see what is working and act on it.</p>
                        </div>
                        <div class="a2zh-pricing-addon-chevron-wrap">
                            <svg class="a2zh-pricing-addon-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                            <svg class="a2zh-pricing-addon-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                        ...
                        <div class="a2zh-pricing-addon-item" data-step="03">
                            <h4>Strategic Advisory</h4>
                            <p>Everything above, plus forecasting and board-level guidance to drive your next stage of growth.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <figure class="a2zh-who-banner a2zh-rv">
                <img src="<?php echo $why_choose_img_1 ? esc_url($why_choose_img_1['url']) : 'https://a2zaccounting.co.uk/wp-content/uploads/2025/08/Home-Page-photo.webp'; ?>"
    ...
    <section class="a2zh-section a2zh-tax-expertise">
        <div class="a2zh-wrap">
            <div class="a2zh-tax-expertise-head a2zh-rv">
                <span class="a2zh-tax-expertise-eyebrow">Deep Tax Expertise</span>
                <h2 class="a2zh-title a2zh-tax-expertise-title">
                    Every new client gets a full<br/>tax restructure free.
                </h2>
                <p class="a2zh-tax-expertise-intro">
                    A chartered accountant reworks your entire setup, the most tax-efficient way the law allows, before we do anything else.
                </p>
            </div>

            <div class="a2zh-tax-cards a2zh-rv">
                <div class="a2zh-tax-card a2zh-d1">
                    <h3>Real HMRC expertise</h3>
                    <p>Years of HMRC enquiries and the complex cases other firms avoid. Our advice comes from real experience, and we stand behind every word.</p>
                </div>
                <div class="a2zh-tax-card a2zh-d2">
                    <h3>Wealth-focused consultancy</h3>
                    <p>Tax-efficient investment and wealth growth, corporate group structuring with HMRC clearance, and advanced family wealth planning.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="a2zh-section a2zh-section--tint a2zh-sectors-sec">
        ...
        ?>
                <a class="a2zh-sector a2zh-rv" href="<?php echo esc_url($link_url); ?>">
                    ...
                    <div class="a2zh-sector-img">
                        <img src="<?php echo esc_url($bg_url); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>"
                            loading="lazy" />
                    </div>
                    <?php endif; ?>
                </a>
        ...
        ?>
                <a class="a2zh-sector a2zh-rv" href="<?php echo esc_url($sc[2]); ?>">
                    ...
                    <?php if ($bg_url) : ?>
                    <div class="a2zh-sector-img">
                        <img src="<?php echo esc_url($bg_url); ?>" alt="<?php echo esc_attr($sc[0]); ?>"
                            loading="lazy" />
                    </div>
                    <?php endif; ?>
                </a>
    ...
    <section class="a2zh-section a2zh-price-guarantee">
        <div class="a2zh-wrap">
            <div class="a2zh-price-guarantee-inner a2zh-rv">
                <span class="a2zh-price-guarantee-eyebrow">OUR PRICE GUARANTEE</span>
                <h2 class="a2zh-title a2zh-price-guarantee-title">
                    One fixed monthly price. <span>No surprise bills. Guaranteed.</span>
                </h2>
                
                <div class="a2zh-price-guarantee-checks">
                    <div class="a2zh-check-item">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#d4a84f" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        <span>Scope agreed up front</span>
                    </div>
                    <div class="a2zh-check-item">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#d4a84f" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        <span>Everything included, no extras</span>
                    </div>
                </div>

                <div class="a2zh-actions" style="justify-content: center;">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#gitModal" data-source="Get a fee estimate" class="a2zh-btn a2zh-btn--solid" style="box-shadow: 0 0 40px rgba(212, 168, 79, 0.35); text-transform: uppercase; font-size: 0.95rem; font-weight: 700; padding: 18px 40px;">GET A FEE ESTIMATE</button>
                </div>
            </div>
        </div>
    </section>
    ...
    ?>
    <section class="a2zh-section a2zh-switching-simple">
        <div class="a2zh-wrap">
            <h2 class="a2zh-title a2zh-switching-simple-title a2zh-rv">
                Switching to us is <span>simple.</span>
            </h2>

            <div class="a2zh-switching-grid a2zh-rv">
                <!-- Arrows -->
                <svg class="a2zh-switching-arrow a2zh-switching-arrow--1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                <svg class="a2zh-switching-arrow a2zh-switching-arrow--2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>

                <div class="a2zh-switching-step">
                    <img src="<?php echo $switch_imgs[0]; ?>" alt="Discovery conversation" class="a2zh-switching-image" loading="lazy" />
                    <div class="a2zh-switching-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                    <span class="a2zh-switching-eyebrow">FIRST</span>
                    <h3>Discovery conversation</h3>
                    <p>We learn your business, your goals, and what your last accountant missed.</p>
                </div>

                <div class="a2zh-switching-step">
                    <img src="<?php echo $switch_imgs[1]; ?>" alt="Structured handover" class="a2zh-switching-image" loading="lazy" />
                    <div class="a2zh-switching-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16M15 2l5 5-5 5M20 17H4M9 22l-5-5 5-5"/></svg>
                    </div>
                    <span class="a2zh-switching-eyebrow">THEN</span>
                    <h3>Structured handover</h3>
                    <p>We deal with your previous accountant and set everything up.</p>
                </div>

                <div class="a2zh-switching-step">
                    <img src="<?php echo $switch_imgs[2]; ?>" alt="Ongoing management" class="a2zh-switching-image" loading="lazy" />
                    <div class="a2zh-switching-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>
                    </div>
                    <span class="a2zh-switching-eyebrow">ONGOING</span>
                    <h3>Ongoing management</h3>
                    <p>Your account runs to a defined system. No drift, no gaps, no chasing.</p>
                </div>
            </div>

            <div class="a2zh-actions a2zh-switching-actions a2zh-rv">
                <button type="button" data-bs-toggle="modal" data-bs-target="#enquireModal" data-source="Switching" class="a2zh-btn a2zh-btn--solid" style="background: #c69d65; border-color: #c69d65; color: #1e293b; text-transform: uppercase; font-size: 0.95rem; font-weight: 700; padding: 18px 40px; box-shadow: 0 10px 30px rgba(198, 157, 101, 0.4);">START THE CONVERSATION</button>
            </div>
        </div>
    </section>
...
(function() {
    ...
    /* ─── journey path removed for simple layout ─── */
