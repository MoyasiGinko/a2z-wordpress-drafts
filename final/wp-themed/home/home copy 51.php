...
.a2zh-pricing-card {
    position: relative;
    background: linear-gradient(180deg, rgba(5, 15, 28, 0.98) 0%, rgba(7, 20, 33, 0.96) 100%);
...
.a2zh-pricing-card--premier {
    background: linear-gradient(160deg, rgba(10, 24, 42, 0.99) 0%, rgba(18, 14, 6, 0.99) 100%);
    border-right: none;
...
.a2zh-pricing-addon {
    position: relative;
    background: linear-gradient(160deg, #050f1c 0%, #071421 100%);
