...
<style>
	.banner-title {
		...
		line-height: clamp(22px, 2.5vw, 34px) !important;
	}

	#a2zwp-hero-scope-v260330 .a2zwp-hero-v260330__title-line--accent {
		font-weight: 600 !important;
		padding-top: 4px;
	...
	#a2zwp-hero-scope-v260330 {
		/* Responsive spacing */
		padding-top: clamp(0px, 1vw, 20px) !important;
	}
...
<section class="hm_banner">
    <?php if($banner_img){ ?>
    <div class="bannerImg">
        <img src="<?php echo $banner_img['url']; ?>" alt="<?php echo $banner_img['alt']; ?>" fetchpriority="high"   decoding="async"   loading="eager">
    </div>
    <?php } ?>
                ...
                <div class="col-lg-12">
                    ...
                    <?php } ?>
                        ...
                        <div class="gp_btn gap-custom">
                            ...
                            <a data-source="<?php echo esc_html( $link_title ); ?>" data-bs-toggle="modal" data-bs-target="#enquireModal" href="<?php echo esc_url(  $link_url ); ?>" class="btn white"><?php echo esc_html( $link_title ); ?></a>
							<?php endif; ?>
        ...
        <div class="afterbanner-inner">
            ...
            <div class="act">
                ...
                <?php
                    ...
                    <button type="button" data-source="<?php echo $focus_btn['title']; ?>" data-bs-toggle="modal" data-bs-target="#gitModal" class="btn">
                        <?php echo $focus_btn['title']; ?>
                    </button>
                    <?php else: ?>

                    <button type="button" data-source="<?php echo esc_attr($btn_title); ?>" data-bs-toggle="modal" data-bs-target="#enquireModal" class="btn">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="account-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/why-account-img-shapes.png" alt="Circle" class="w450px">
                        <div class="imgsec">
                ...
                <div class="col-md-6">
                    <div class="account-txt">
                        ...
                        <h5><a href="#testimonials"><?php echo get_field('why_choose_sub_title'); ?> <img src="<?php echo get_template_directory_uri(); ?>/images/why-account-down-arrow.jpg" alt="down arrow"></a></h5>
                        <?php } ?>
        ...
        <div class="row justify-content-between flex-md-row-reverse">
            ...
            <div class="col-md-6">
                <div class="promisetxt">
                    ...
                    <button type="button" data-source="<?php echo esc_attr($btn_title); ?>" data-bs-toggle="modal" data-bs-target="#enquireModal" class="btn blue">
                        <?php echo esc_html($btn_title); ?>
                    </button>
...
<section class="switch">
    <span class="switchbg"><img src="<?php echo get_template_directory_uri(); ?>/images/switch-bg.png" alt="background"></span>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="swtichimg">
...
?>
<section class="getquote" style="background: url(<?php echo $get_a_quote_bg_img['url']; ?>) no-repeat 0 0; background-size: cover !important;" id="getquote">
    <div class="container">
        <div class="row">
                ...
                <div class="col-md-6">
                    <div class="dwn_dts">
                        ...
                        <?php if($download_file){ ?>
                            <a target="<?php echo $download_file_target; ?>" href="<?php echo $download_file['url']; ?>" class="btn"><?php echo $download_file['title']; ?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<section class="blogSec">
    <div class="container">
        ...
        <?php
            ...
            ?>
            <a target="<?php echo esc_attr( $our_blogs_btn_target ); ?>" href="<?php echo $our_blogs_btn['url']; ?>" class="btn blue"><?php echo $our_blogs_btn['title']; ?></a>
        </div>
    </div>
</section>
<?php if(is_page(36959)){ ?>
...
<!-- Modal -->
<div class="modal service-table fade" id="service-table" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
window.calculateTotal = function() {
    ...
    let annualAccountsPrice = annualAccounts === 'Yes' && selectedRange ? selectedRange.annual_accounts_corporation_tax : 0;
