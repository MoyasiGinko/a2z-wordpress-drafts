...
.a2zh-hero-kinetic {
  ...
  display: flex;
  align-items: center;
  padding: clamp(140px, 15vw, 180px) 0 clamp(100px, 12vw, 140px);
  overflow: hidden;
}
...
.a2zh-kinetic-ring {
  position: absolute;
  border-radius: 50%;
  border: 1px solid rgba(45, 147, 212, 0.35);
...
.a2zh-btn--kinetic-primary {
  ...
  border-radius: 100px;
  overflow: hidden;
  box-shadow: 0 16px 32px rgba(12, 39, 66, 0.2);
  display: inline-flex;
  align-items: center;
}
...
.a2zh-btn--kinetic-primary:hover {
  ...
  box-shadow: 0 20px 40px rgba(12, 39, 66, 0.3);
  color: #fff;
}
...
@media (max-width: 1024px) {
  .a2zh-kinetic-title span { background-size: 300% auto; }
}
...
/* ════ TESTIMONIALS ════ */
.a2zh-testimonials-sec {
  position: relative;
}

.a2zh-testimonials-sec::before {
  content: "";
  position: absolute;
  inset: 0;
  background: linear-gradient(to bottom, #ffffff 0%, transparent 100%);
...
.a2zh-testimonials-sec .a2zh-wrap {
  position: relative;
  z-index: 1;
}
...
/* ════ TESTIMONIALS — auto-scrolling marquee rows ════ */
.a2zh-tm {
  position: relative;
  display: grid;
  gap: 16px;
...
.a2zh-tm-track {
  ...
  gap: 16px;
  width: max-content;
  animation: a2zh-tm-scroll 48s linear infinite;
}

/* second row runs the opposite way */
.a2zh-tm-row--rev .a2zh-tm-track {
  animation-direction: reverse;
}

.a2zh-tm-row:hover .a2zh-tm-track {
  animation-play-state: paused;
}

@keyframes a2zh-tm-scroll {
  from {
...
.a2zh-tm-card {
  ...
  border: 1px solid var(--glass-brd);
  box-shadow: 0 12px 30px rgba(13, 79, 124, 0.08);
...
.a2zh-tm-card:hover {
  transform: translateY(-4px);
  border-color: rgba(45, 147, 212, 0.45);
  box-shadow: 0 22px 46px rgba(8, 29, 51, 0.16);
}
...
.a2zh-tm-card:hover .a2zh-tm-play {
  background: rgba(26, 111, 168, 0.6);
}
...
.a2zh-resources-kinetic::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 15% 50%, rgba(45, 147, 212, 0.15) 0%, transparent 60%);
  pointer-events: none;
}
...
.a2zh-resources-kinetic .a2zh-btn--ghost:hover {
  border-color: var(--cyan);
  background: rgba(45, 147, 212, 0.1);
  color: var(--cyan);
}

/* ════ CTA / GET A QUOTE (Kinetic) ════ */
.a2zh-cta {
  background: radial-gradient(circle at 50% 100%, var(--navy-deepest) 0%, var(--navy-deep) 100%);
  color: #fff;
  position: relative;
  overflow: hidden;
...
.a2zh-cta::before {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 80% 50%, rgba(45, 147, 212, 0.4) 0%, transparent 55%),
    radial-gradient(circle at 10% 80%, rgba(26, 111, 168, 0.25) 0%, transparent 60%);
  pointer-events: none;
...
.a2zh-cta .a2zh-btn--soft:hover {
  ...
  color: #fff;
  transform: translateY(-2px);
  box-shadow: 0 12px 32px rgba(45, 147, 212, 0.4);
}
...
.a2zh-cta .a2zh-btn--ghost:hover {
  border-color: var(--cyan);
  background: rgba(45, 147, 212, 0.15);
  color: var(--cyan);
  transform: translateY(-2px);
}
...
.a2zh-contact-stack:hover {
  transform: translateY(-4px);
  border-color: rgba(45, 147, 212, 0.5);
  box-shadow: 0 40px 80px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(45, 147, 212, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.3);
}
...
.a2zh-contact-card:hover {
  background: linear-gradient(90deg, rgba(45, 147, 212, 0.15) 0%, transparent 100%);
  padding-left: 38px;
}
...
.a2zvt__thumb:hover .a2zvt__thumb-img { transform: scale(1.04); }
.a2zvt__thumb::before {
  content: "";
  position: absolute;
  inset: 0;
...
.a2zvt__play {
  ...
  height: 58px;
  border-radius: 50%;
  background: rgba(45, 147, 212, 0.9);
...
.a2zvt__avatar {
  ...
  height: 42px;
  border-radius: 50%;
  background: rgba(45,147,212,0.18);
  border: 1px solid rgba(45,147,212,0.3);
  display: flex;
  align-items: center;
  justify-content: center;
  flex-shrink: 0;
...
.a2zvt__arrow:hover {
  border-color: rgba(45,147,212,0.8);
  background: rgba(45,147,212,0.12);
  color: #fff;
  transform: scale(1.1);
}
.a2zvt__arrow-svg {
...
@media (max-width: 720px) {
  .a2zvt { border-radius: 16px; }
  .a2zvt__slide { grid-template-columns: 1fr; }
  .a2zvt__thumb { min-height: 0; aspect-ratio: 16/9; }
  .a2zvt__body { border-left: none; border-top: 1px solid rgba(255,255,255,0.07); padding: 24px; }
  .a2zvt__controls { flex-direction: row; }
}
</style>
...
<main class="a2zh-home" id="a2zh-home">
  ...
  <section class="a2zh-hero-kinetic" <?php if ($banner_url) : ?>
    style="background-image: linear-gradient(180deg, rgba(12,39,66,0.95) 0%, rgba(12,39,66,0.5) 40%, rgba(12,39,66,0) 100%), linear-gradient(0deg, rgba(253,253,253,1) 0%, rgba(253,253,253,0) 100%), url('<?php echo esc_url($banner_url); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
  <?php endif; ?>>
        ...
        <div class="a2zvt a2zh-rv a2zh-d3" id="a2zvt">
          <div class="a2zvt__track" id="a2zvt-track">
            ...
            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/8761cb23b0a34e558b8867204c69e68f?sid=03ed2529-3243-45c6-a8e8-cfe8dfdfbfdc" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/Testimonial-–-a2z-accounting-06-04-2025_12_21_PM-21.png" alt="Kevin Smith" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;Building a real relationship with our accountant, not just handing over paperwork like before&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Kevin Smith</div><div class="a2zvt__role">Owner, The Drouthy Cobbler &ndash; Elgin &amp; Spey Life &ndash; Forres</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">1 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/7878b7d8ae564fb7822bcc706a5efc33?sid=9ba321ad-2b32-47d8-9b10-4c35befedbb4" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/04/testi-img-1.jpg" alt="Mrs. Rona Tonge" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;An absolute pleasure to work with!&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Mrs. Rona Tonge</div><div class="a2zvt__role">Managing Director, Golf View Hotel &ndash; Lossiemouth</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">2 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/9caff76064d2408c8193cb5406ef69ea?sid=d94dc925-fc5a-4791-9d7f-ec17f8c61099" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/3.png" alt="Mr. Mohamed Ali" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;As they grow, we grow&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Mr. Mohamed Ali</div><div class="a2zvt__role">Property Tycoon &amp; Owner, MacAli Hotel Group &ndash; Elgin</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">3 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/157bd97bdd42416497aab3ccf8de5843?sid=69be3f94-62e4-4707-a7a1-a62d331a205a" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/4-1024x787.png" alt="Behrouz Abolghassem" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;My business grew stress-free&mdash;want a good life? Move to A2Z.&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Behrouz Abolghassem</div><div class="a2zvt__role">Owner, Little Italy &ndash; St Andrews</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">4 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/6e7d53d784924c84a5240d390cf0e40b?sid=f5faf8ce-1882-4c2d-aaac-6fa91e6cafd4" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/5.png" alt="Christopher O'Halloran" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;The friends I referred to A2Z faced challenges, but those who made the move to A2Z couldn&rsquo;t thank me enough&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Christopher O&rsquo;Halloran</div><div class="a2zvt__role">Owner, The Green Inn &ndash; Ballater</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">5 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/0f25c7b69a2e4af4bac8d720949df52b?sid=6cca37ba-b380-4659-b3f7-492a6a0c270e" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/6-1024x846.png" alt="Khuram Qadir CEng" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;You really get to know your accountant when you&rsquo;re in the deep end.&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Khuram Qadir CEng</div><div class="a2zvt__role">Founder &amp; Oil &amp; Gas Engineer, Cygnas Solutions &ndash; Aberdeen</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">6 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/71e4d66232384e49ad4642d862c65f73?sid=1ceca9bb-b0bd-43e7-bf28-ed5a78eae4a3" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/7.png" alt="Mrs. Lisa Morrison" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;Every team member is exceptionally supportive&mdash;always quick to assist and resolve&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Mrs. Lisa Morrison</div><div class="a2zvt__role">Treasurer, Seaforth Club &ndash; Nairn</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">7 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/93fa845584ea405891cbf002857eff90?sid=577353ff-833d-468c-b323-13c2dd81bdc3" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/8.webp" alt="Mr. Hosam Yousef" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;I can trust them to handle everything while I focus on growing my business&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Mr. Hosam Yousef</div><div class="a2zvt__role">Pharmacist &amp; Pharmacy Owner &ndash; Aberdeen</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">8 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/6a780d36e37a4a308ffcfaa4b5c574d6?sid=8a02ccd9-9067-4a15-873b-8f2acd06dba7" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/9.png" alt="Lesia Robertson" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;A2Z are the most amazing accountants&mdash;turning my sleepless nights into clarity and confidence.&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Lesia Robertson</div><div class="a2zvt__role">Director, Mamma Mia &ndash; Banchory</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">9 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/fd60672b40cf4103a1f5c30f0ddfe884?sid=652f2519-2d2e-4aa2-87a0-22522d95a0bf" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/10.webp" alt="Nurul Hoque Ali" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">Oil &amp; Gas Engineering Consultant &ndash; Aberdeen</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Nurul Hoque Ali</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">10 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/13ce4a974d34447baf27484eebf9b93f?sid=c808bb8a-53ed-451c-befb-ce214241f5df" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/11.png" alt="Kimberley Welsh" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;Switching to A2Z has been a game-changer &ndash; fast, efficient, and helped improve my knowledge!&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Kimberley Welsh</div><div class="a2zvt__role">Owner, Ca&rsquo;dora Diner &ndash; Elgin</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">11 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/309b1b0e1364427ab246273db38147ab?sid=6ee63d23-fd48-4854-b0c0-6fe7456a6b20" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/12-1024x859.webp" alt="Ameer Aslam" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;Switched accountants a week before the deadline&mdash;A2Z handled everything flawlessly.&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Ameer Aslam</div><div class="a2zvt__role">Owner, Nickel &amp; Dime &ndash; Various</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">12 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/3e5ec41c4e4c4373bf29d8eee84788cb?sid=68038677-011d-4bb0-994e-34249e4f662a" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/13.png" alt="Ms. Cassandara-Jane Thornton" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;A2Z transformed our chaotic accounts, making the impossible achievable&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Ms. Cassandara-Jane Thornton</div><div class="a2zvt__role">Owner, West End Hotel &ndash; Nairn</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">13 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/a541d08386e4430f9f24cf73c2d8555b?sid=99e89d9f-52da-4f65-899d-c649c587f5bb" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/14.png" alt="Dr. Hassan Abbas" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;7 years of unwavering support&mdash;A2Z navigates VAT complexities and fuels my clinic&rsquo;s growth!&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Dr. Hassan Abbas</div><div class="a2zvt__role">Managing Director &amp; Consultant Cardiologist, Hourglass Wellbeing &ndash; Aberdeen</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">14 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>

            <div class="a2zvt__slide">
              <a href="https://www.loom.com/embed/921fccbea4f843c491d01bcbd43ecb59?sid=6c19fc7e-8e90-4300-ae8b-0dc869a26a81" data-lity class="a2zvt__thumb"><img class="a2zvt__thumb-img" src="https://a2zaccounting.co.uk/wp-content/uploads/2025/06/15.png" alt="Hassan Nazer" loading="lazy"><span class="a2zvt__play"><span class="a2zvt__play-icon"></span></span></a>
              <div class="a2zvt__body"><div><div class="a2zvt__meta"><span class="a2zvt__eyebrow">Trusted by ambitious businesses</span><span class="a2zvt__stars">★★★★★</span></div><p class="a2zvt__quote">&ldquo;They&rsquo;ve got a solution for every problem&rdquo;</p><div class="a2zvt__author"><span class="a2zvt__avatar"><svg class="a2zvt__avatar-icon" viewBox="0 0 24 24"><path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v2h20v-2c0-3.3-6.7-5-10-5z"/></svg></span><div><div class="a2zvt__name">Hassan Nazer</div><div class="a2zvt__role">British Film Director &amp; Entrepreneur &ndash; Aberdeen</div></div></div></div><div class="a2zvt__divider"></div><div class="a2zvt__controls"><span class="a2zvt__counter">15 / 15</span><div class="a2zvt__nav"><button class="a2zvt__arrow a2zvt-prev" type="button" aria-label="Previous"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="15 18 9 12 15 6"/></svg></button><button class="a2zvt__arrow a2zvt-next" type="button" aria-label="Next"><svg class="a2zvt__arrow-svg" viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18"/></svg></button></div></div></div>
            </div>
          ...
          <svg viewBox="0 0 1000 58" preserveAspectRatio="none">
            <defs>
              <linearGradient id="podGradMain" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stop-color="rgba(45, 147, 212, 0)" />
                <stop offset="15%" stop-color="rgba(45, 147, 212, 0.8)" />
                <stop offset="50%" stop-color="rgba(45, 147, 212, 1)" />
                <stop offset="85%" stop-color="rgba(45, 147, 212, 0.8)" />
                <stop offset="100%" stop-color="rgba(45, 147, 212, 0)" />
              </linearGradient>
              <linearGradient id="podGradSub" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stop-color="rgba(26, 111, 168, 0)" />
                <stop offset="15%" stop-color="rgba(26, 111, 168, 0.5)" />
                <stop offset="50%" stop-color="rgba(26, 111, 168, 0.8)" />
                <stop offset="85%" stop-color="rgba(26, 111, 168, 0.5)" />
                <stop offset="100%" stop-color="rgba(26, 111, 168, 0)" />
              </linearGradient>
            </defs>
            <path class="a2zh-thread-path" d="M 0,29 C 150,64 350,64 500,29 C 650,-6 850,-6 1000,29" stroke="url(#podGradMain)" />
            <path class="a2zh-thread-path-2" d="M 0,29 C 150,-6 350,-6 500,29 C 650,64 850,64 1000,29" stroke="url(#podGradSub)" />
          </svg>
        </div>
        <?php
  ...
  <!-- ════════ TESTIMONIALS ════════ -->
  <section class="a2zh-section a2zh-section--tint a2zh-testimonials-sec" id="testimonials">
    <div class="a2zh-wrap">
      <div class="a2zh-head">
        <div>
      ...
      while ($t_results->have_posts()) : $t_results->the_post();
        ...
        $tw[] = [
          'img'   => $t_image[0] ?? '',
          'name'  => get_the_title(),
          'role'  => get_field('designation', get_the_ID()),
          'quote' => wp_trim_words(get_the_content(), 20),
          'stars' => (int) get_field('star', get_the_ID()),
          'video' => is_array($t_video) ? ($t_video['url'] ?? '#') : ($t_video ?: '#'),
        ];
      endwhile;
      wp_reset_postdata();

      $render_tm = function ($c) {
        $stars = '';
        if ($c['stars']) {
          for ($s = 1; $s <= 5; $s++) {
            $stars .= $s <= $c['stars'] ? '&#9733;' : '<span class="off">&#9733;</span>';
          }
        }
        ?>
        <a class="a2zh-tm-card" href="<?php echo esc_url($c['video']); ?>" data-lity>
          <?php if ($stars) : ?><div class="a2zh-tm-stars"><?php echo $stars; ?></div><?php endif; ?>
          <p class="a2zh-tm-quote"><?php echo $c['quote']; ?></p>
          <div class="a2zh-tm-foot">
            <span class="a2zh-tm-avatar">
              <?php if ($c['img']) : ?><img src="<?php echo esc_url($c['img']); ?>"
                alt="<?php echo esc_attr($c['name']); ?>" loading="lazy" /><?php endif; ?>
              <span class="a2zh-tm-play"><i class="fa-solid fa-play"></i></span>
            </span>
            <span class="a2zh-tm-meta">
              <strong><?php echo $c['name']; ?></strong>
              <?php if ($c['role']) : ?><span><?php echo $c['role']; ?></span><?php endif; ?>
            </span>
          </div>
        </a>
        <?php
      ...
      ?>
      <?php if ($tw) : ?>
      <div class="a2zh-tm a2zh-rv">
        <div class="a2zh-tm-row">
          <div class="a2zh-tm-track">
            <?php foreach ($tw as $c) $render_tm($c);
            foreach ($tw as $c) $render_tm($c); ?>
          </div>
        </div>
        <div class="a2zh-tm-row a2zh-tm-row--rev">
          <div class="a2zh-tm-track">
            <?php $rev = array_reverse($tw);
            foreach ($rev as $c) $render_tm($c);
            foreach ($rev as $c) $render_tm($c); ?>
          </div>
        </div>
      </div>
...
(function() {
  ...
  (function() {
    ...
    var timer = setInterval(function() { goTo(cur + 1); }, 6000);
    slider.addEventListener('pointerenter', function() { clearInterval(timer); });
    slider.addEventListener('pointerleave', function() { timer = setInterval(function() { goTo(cur + 1); }, 6000); });
  })();
