...
.principles-head-left .label {
  display: block;
  margin-bottom: 20px;
}

.principles-head-left .display-lg {
  color: var(--white);
}

.principles-head-left .display-lg em {
  color: var(--gold);
}

.principles-head-right {
  max-width: 56ch;
  text-align: left;
  align-self: flex-start;
}

.principles-head-right p {
  font-size: 1.05rem;
  line-height: 1.9;
  color: rgba(255, 255, 255, 0.7);
  font-weight: 400;
...
.guar-row:hover .guar-badge-ring {
  border-color: var(--gold);
  background: var(--gold-10);
}
...
.guar-row:hover .guar-badge-ring svg {
  opacity: 1;
}
...
@media (max-width: 900px) {
  ...
  .hero-inner {
    ...
    gap: 0;
    align-items: start;
    padding-top: clamp(78px, 14vw, 112px);
...
@media (max-width: 380px) {
  ...
  .hero-heading {
    font-size: clamp(2.85rem, 17vw, 3.8rem);
  }
    ...
    <svg viewBox="0 0 500 800" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      <g>
        <path d="M 500 0 C 75,145 38,385 152,548 C 268,712 500,762 500,800" fill="none" stroke="rgba(176,141,87,0.17)"
          stroke-width="1.05" />
        <path d="M 500 52 C 128,182 92,400 194,558 C 298,716 476,764 476,800" fill="none" stroke="rgba(176,141,87,0.10)"
          stroke-width="0.7" />
      ...
      <path d="M 500 52 C 128,182 92,400 194,558 C 298,716 476,764 476,800" fill="none" stroke="rgba(201,169,110,0.5)"
        ...
        <animate attributeName="stroke-dashoffset" from="0" to="3045" dur="6s" begin="2.4s" repeatCount="indefinite" />
      </path>
      <g>
  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <p class="hero-sub reveal d2">
        FCCA chartered accountants in Aberdeen — supporting 200+ UK
        businesses with proactive tax planning, fully managed accounting,
        and Big&nbsp;4-grade financial management. Specialist departments.
        Four independent quality layers. Director oversight on every
        engagement.
      </p>
      <div class="hero-meta reveal d3">
        <div class="hero-meta-item">
          <div class="hero-meta-val">200+</div>
          <div class="hero-meta-lbl">UK businesses supported</div>
        </div>
        <div class="hero-meta-item">
          <div class="hero-meta-val">98%</div>
          <div class="hero-meta-lbl">Client retention rate</div>
        </div>
        <div class="hero-meta-item">
          <div class="hero-meta-val">7+</div>
          <div class="hero-meta-lbl">Years in practice</div>
        </div>
      </div>
      <div class="hero-ctas reveal d4">
        <a href="/contact/" class="btn btn-gold">Speak With Our Team &rarr;</a>
        <a href="/what-we-do-well/" class="btn btn-ghost-light">Our Services &rarr;</a>
      </div>
    </div>
...
<section class="metrics" aria-label="Key performance metrics">
  <div class="metrics-inner">
    <div class="metric-item reveal">
      ...
      <span class="metric-lbl">UK businesses<br />supported</span>
    </div>
    <div class="metric-item reveal d1">
      <span class="metric-num">98%</span>
      <span class="metric-lbl">Client retention<br />rate</span>
    </div>
    <div class="metric-item reveal d2">
      <span class="metric-num">7+</span>
      <span class="metric-lbl">Years delivering<br />Big 4-grade standards</span>
    </div>
  ...
  <div class="story-inner">
    ...
    <div class="story-sidebar reveal">
      ...
      <h2 class="story-sidebar-head" style="margin-top: 20px">
        A discipline learned<br />
        <em>somewhere different.</em>
      </h2>
    </div>

    <!-- Chained paragraph content -->
    <div class="story-chain">
      <div class="sp-item" data-story-idx="0">
        ...
        <div class="sp-body">
          <p>
            It began deep beneath the North Sea at Subsea&nbsp;7, where
            Shabbir Rahman managed complex group accounts and operated to
            the full rigour of Big&nbsp;4 audit standards — Deloitte and EY
            scrutinising every number, every quarter, without exception.
          </p>
        </div>
      </div>
      ...
      <div class="sp-item" data-story-idx="1">
        ...
        <div class="sp-body">
          <p>
            Those years demanded bulletproof processes, precise systems, and
            zero tolerance for error. When A2Z was founded in 2018, that
            discipline was not aspirational — it was operational from the
      ...
      <div class="sp-item sp-item--quote" data-story-idx="2">
        ...
        <div class="sp-body">
          <blockquote>
            We did not build another accounting firm. We built the finance
            function that growing businesses deserved and never had access
            to.
          </blockquote>
      ...
      <div class="sp-item" data-story-idx="3">
        ...
        <div class="sp-body">
          <p>
            A2Z was built on an entirely different model: specialist
            departments rather than generalists, multiple independent
            quality-control layers rather than a single reviewer, and FCCA
            director-level oversight on every single client engagement.
          </p>
        </div>
      </div>
      ...
      <div class="sp-item" data-story-idx="4">
        ...
        <div class="sp-body">
          <p>
            One hundred per cent paperless, proactively managed, and
            delivered to the standards Shabbir applied at corporate level —
            only now to the clients who had previously been priced out of
            them.
          </p>
        </div>
      </div>
  ...
  <div class="principles-inner">
    <div class="principles-head">
      <div class="principles-head-left">
        <!--         <span class="label reveal">Why Businesses Choose A2Z Accounting</span> -->
        <h2 class="display-lg reveal d1" style="margin-top: 0px">
      ...
      <div class="principles-head-right reveal d2">
        <p>
          Most firms compete on price. We compete on outcomes. These three principles shape every client engagement at
          A2Z and define how our
          <a href="/what-we-do-well/" style="color: var(--gold); text-decoration: none">services</a>
          are delivered.
        </p>
      </div>
    </div>
    ...
    <div class="principles-grid">
      <article class="principle-item reveal">
        ...
        <p>
          Low accounting creates expensive problems. We price for the value
          delivered — certainty, accuracy, and measurable strategic
          advantage.
        </p>
      </article>
      <article class="principle-item reveal d1">
        ...
        <p>
          Every engagement is for specific, guaranteed outcomes — fixed-fee,
          fully scoped, and confirmed in writing before any work begins.
        </p>
      </article>
      <article class="principle-item reveal d2">
        ...
        <p>
          We prevent them. The four-layer quality structure identifies and
          resolves issues long before they reach you — or HMRC.
        </p>
      </article>
    </div>
    ...
    <div class="principles-manifesto reveal">
      ...
      <a href="/contact/" class="btn btn-ghost-light">Discuss Your Growth Plans &rarr;</a>
    </div>
  </div>
</section>
  ...
  <div class="layers-inner">
    <div class="layers-head">
      <div class="layers-head-left">
        <!--         <span class="label reveal">Proactive Financial Management</span> -->
        <h2 class="display-lg reveal d1" style="margin-top: 0px">
          Four layers of review.<br />
          <em>Every single time.</em>
        </h2>
      </div>
      <div class="layers-head-right reveal d2">
        <p>
          No output leaves A2Z without passing through every layer. Not a
          checklist — a structural guarantee, built into how the firm
          operates at every client tier. This is what separates
          <a href="/about/" style="color: var(--gold-lt); text-decoration: none">fully managed accounting</a>
          from standard bookkeeping.
        </p>
      </div>
    </div>
    ...
    <div class="layers-stack">
      <div class="layer-panel reveal" data-watermark="ORIGINATION">
        <div class="layer-ring">
          <span class="layer-ring-num">i</span>
        </div>
        <div class="layer-body">
          <h4>Specialist Completes</h4>
          <p>
            Work completed by a department specialist with focused, deep
      ...
      <div class="layer-panel reveal d1" data-watermark="TECHNICAL CHECK">
        <div class="layer-ring">
          <span class="layer-ring-num">ii</span>
        </div>
        <div class="layer-body">
          <h4>Department Review</h4>
          <p>
            The department head independently reviews for technical
      ...
      <div class="layer-panel reveal d2" data-watermark="COMPLIANCE">
        <div class="layer-ring">
          <span class="layer-ring-num">iii</span>
        </div>
        <div class="layer-body">
          <h4>Senior Verification</h4>
          <p>
            A senior accountant verifies regulatory compliance and
            identifies proactive planning opportunities.
          </p>
        </div>
      </div>
      ...
      <div class="layer-panel reveal d3" data-watermark="FINAL RELEASE">
        <div class="layer-ring">
          <span class="layer-ring-num">iv</span>
        </div>
        <div class="layer-body">
          <h4>Director Approval</h4>
          <p>
            The FCCA director personally approves every output before
...
<section class="opt-c">
  <div class="opt-c-inner">
    <div class="sect-head on-dark">
      <div>
        <!--         <span class="sect-head-eyebrow">Fully Managed Accounting Support</span> -->
        <h2>Three specialists.<br /><em>One point of contact.</em></h2>
      </div>
      <div class="sect-head-right">
        <p>
          Generalist firms ask one accountant to do everything. We separate
          the disciplines — payroll, VAT, and year-end tax — so each area is
          handled by a specialist whose entire focus is that work.
          <a href="/what-we-do-well/" style="color: var(--gold-lt); text-decoration: none; opacity: 0.85;">Explore all
            services &rarr;</a>
        </p>
      </div>
    </div>
    ...
    <div class="c-grid">
      <div class="c-col">
        ...
        <div class="c-content">
          ...
          <p class="c-desc">
            Full-service payroll and credit control — RTI, PAYE, pension
            auto-enrolment, and accounts receivable.
          </p>
          <ul class="c-services">
            <li>RTI submissions and PAYE management</li>
            <li>Pension auto-enrolment administration</li>BOT
      ...
      <div class="c-col">
        ...
        <div class="c-content">
          ...
          <p class="c-desc">
            MTD-compliant bookkeeping, quarterly VAT returns, and regular
      ...
      <div class="c-col">
        ...
        <div class="c-content">
          ...
          <p class="c-desc">
            Annual accounts, Corporation Tax, self-assessment, and
...
<section class="guarantees">
  <div class="guar-head">
    <div>
      <!--       <span class="label reveal" style="display: block; margin-bottom: 20px">Contractual Commitments</span> -->
      <h2 class="display-lg reveal d1">
        Three commitments.<br /><em>All in writing.</em>
      </h2>
    </div>
    <div class="guar-head-right">
      <p class="reveal">
        Not aspirational promises — contractual obligations, included in every engagement letter, measurable in
        delivery, transparently communicated, and enforceable from day one without exception.
      </p>
    </div>
  </div>
  ...
  <div class="guar-rows">
    <div class="guar-row reveal">
      ...
      <div class="guar-body">
        ...
        <p>
          Any query submitted before midday on a working day receives a
          substantive response the same day. Not an acknowledgement — a real
          answer.
        </p>
      </div>
    ...
    <div class="guar-row reveal d1">
      ...
      <div class="guar-body">
        ...
        <p>
          Every HMRC and Companies House deadline is met proactively, well
          in advance. No last-minute rushes, no penalty exposure.
        </p>
      </div>
      <div class="guar-badge">
        <div class="guar-badge-ring">
    ...
    <div class="guar-row reveal d2">
      ...
      <div class="guar-body">
        ...
        <p>
          Your monthly fee is agreed, confirmed in writing, and never
          changes without your prior approval. No hourly billing, no
          surprise invoices.
        </p>
      </div>
      <div class="guar-badge">
...
<section class="testimonials">
  <div class="testimonials-inner">
    <div class="testimonials-head reveal">
      ...
      <p>
        Over 200 UK businesses trust A2Z with their financial management.
        Here is what a few of them say — in their own words. You can read
        all verified reviews directly on
        <a href="#reviews" style="color: var(--gold); text-decoration: none">Google</a>.
      </p>
    </div>
    ...
    <div class="testimonials-grid">
      <div class="testi-card reveal">
        ...
        <p class="testi-quote">
          Switching to A2Z was the best financial decision we made. They
          found tax planning opportunities our previous accountant had
          missed for three years — the savings more than covered the entire
          year's fee.
        </p>
        <div class="testi-author">
          <span class="testi-name">James Whitfield</span>
          <span class="testi-role">Construction &amp; Contracting</span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d1">
        <div class="testi-stars">★★★★★</div>
        <p class="testi-quote">
          A2Z completely changed how we manage financial reporting. The
          four-layer review means I can trust every number that comes out of
          their office. I have not had a single query from HMRC since
          joining.
        </p>
        <div class="testi-author">
          <span class="testi-name">Sarah Chen</span>
          <span class="testi-role">Professional Services &amp; Consulting</span>
        </div>
      </div>
      ...
      <div class="testi-card reveal d2">
        <div class="testi-stars">★★★★★</div>
        <p class="testi-quote">
          The same-day response guarantee is not marketing — they actually
          deliver on it, every time. Having a director personally sign off
          on our accounts gives us a level of confidence we have never had
          before.
        </p>
        <div class="testi-author">
          <span class="testi-name">Mohammed Al-Rashid</span>
          <span class="testi-role">E-commerce &amp; Retail</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="cta-body reveal">
      <div class="cta-left">
        ...
        <h2 class="contact-heading">
          Ready to work<br /><em>accountants who deliver?</em>
        </h2>
      </div>
      <div class="cta-right">
        <p class="cta-sub">
          No sales pitch — a direct, no-obligation conversation with a
          chartered accountant about your business, your goals, and the tax
          planning and financial management opportunities available to you.
        </p>
        <div class="contact-ctas">
          <a href="/contact/" class="btn btn-gold">Speak With a Chartered Accountant &rarr;</a>
  ...
  <div class="reviews-inner">
    <div class="reviews-head reveal">
      <div class="reviews-head-left">
        <!--         <span class="reviews-eyebrow">Google Reviews</span> -->
        <h2>Trusted by growing businesses<br /><em>across the UK.</em></h2>
      </div>
      <div class="reviews-head-right">
        <p>
          Read what our clients say about working with A2Z Accounting
          Solutions — verified reviews, straight from Google.
        </p>
        <div class="reviews-stars">
          <span class="reviews-stars-icons">★★★★★</span>
          <span class="reviews-stars-score">5.0</span>
          <span class="reviews-stars-count">Google Reviews</span>
        </div>
      </div>
    </div>
    ...
    <div class="reviews-footer reveal d2">
      <div class="reviews-footer-logo">
        ...
        <span>Verified Google Reviews · Powered by Elfsight</span>
      </div>
    </div>
  </div>
</section>
    ...
    (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          ...
          if (!isNaN(idx) && progItems[idx]) {
            progItems[idx].classList.add("sp-prog-active");
          }
        } else {
          entry.target.classList.remove("sp-active");
          if (!isNaN(idx) && progItems[idx]) {
            progItems[idx].classList.remove("sp-prog-active");
          }
        }
      });
    }, {
    ...
    (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          const idx = parseInt(entry.target.dataset.storyIdx, 10);
          if (!isNaN(idx)) {
            if (currentProgIdx >= 0 && progItems[currentProgIdx]) {
              progItems[currentProgIdx].classList.remove("sp-prog-current");
            }
            if (progItems[idx]) {
              progItems[idx].classList.add("sp-prog-current");
            }
            currentProgIdx = idx;
          }
        }
