...
<section class="story team">
  <div class="story-inner">
    <div class="story-sidebar reveal">
      ...
      <p class="story-sidebar-copy">
        Specialist roles, director oversight, and clear accountability across payroll, VAT, bookkeeping, tax, and client
        support.
      </p>
    </div>

    <div class="story-chain team-chain">
        ...
        <div class="sp-body">
          <div class="team-profile">
            ...
            <div class="team-profile-body">
              ...
              <span class="team-profile-role">Founder &amp; Chief Executive</span>
              <p>
                Director-level oversight across client engagements, drawing on Subsea 7 group-accounting experience and
                Big 4 audit standards from Deloitte and EY.
              </p>
            </div>
          </div>
        </div>
      ...
      <article class="sp-item" data-story-idx="1">
        ...
        <div class="sp-body">
          <div class="team-profile">
            <div class="team-profile-media"><span class="team-profile-initials">M</span></div>
            <div class="team-profile-body">
              <h3>Mahfuza</h3>
              <span class="team-profile-role">Client Accounts Support</span>
              <p>
                Supports clients with practical accounting queries, document handling, and prompt resolution of
                tax-return and compliance issues.
              </p>
            </div>
          </div>
        </div>
      ...
      <article class="sp-item" data-story-idx="2">
        ...
        <div class="sp-body">
          <div class="team-profile">
            <div class="team-profile-media"><span class="team-profile-initials">E</span></div>
            <div class="team-profile-body">
              <h3>Emma</h3>
              <span class="team-profile-role">Accounting Team Support</span>
              <p>
                Helps keep client communication moving quickly, coordinating records, follow-ups, and day-to-day
                accounting support across the team.
              </p>
            </div>
          </div>
        </div>
      ...
      <article class="sp-item" data-story-idx="3">
        ...
        <div class="sp-body">
          <div class="team-profile">
            <div class="team-profile-media"><span class="team-profile-initials">A2Z</span></div>
            <div class="team-profile-body">
              <h3>Specialist Team</h3>
              <span class="team-profile-role">Payroll, VAT, Accounts &amp; Tax</span>
              <p>
  ...
  <div class="opt-c-inner">
    <div class="sect-head on-dark solo-head">
      <div>
        ...
        <h2>Three specialists <em>Each brings a depth of relevant expertise &amp; provides fast turnaround</em>
        </h2>
      </div>
    </div>
