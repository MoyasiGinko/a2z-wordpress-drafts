...
<style>
        ...
        *, *::before, *::after {
        ...
        .feature-card:hover {
            ...
            box-shadow: 0 20px 45px rgba(7, 21, 36, 0.08);
        }
        ...
        .footer-logo-box .logo-text-title {
            color: var(--color-white);
        }
                    ...
                    <div class="addon-col">
                        ...
                        <div class="addon-icon">
                            ...
                            <svg width="40" height="28" viewBox="-3 -3 40 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0" y="0" width="10" height="10" rx="3" fill="#D4A84F" style="filter: drop-shadow(0px 0px 6px rgba(212,168,79,1));"/>
                                <rect x="12" y="0" width="10" height="10" rx="3" fill="#5D6D82"/>
                                <rect x="24" y="0" width="10" height="10" rx="3" fill="#5D6D82"/>
                                <rect x="0" y="12" width="10" height="10" rx="3" fill="#5D6D82"/>
                                <rect x="12" y="12" width="10" height="10" rx="3" fill="#E8D595"/>
                                <rect x="24" y="12" width="10" height="10" rx="3" fill="#5D6D82"/>
                            </svg>
                        </div>
                    ...
                    <div class="addon-col addon-col-middle">
                        ...
                        <div class="addon-icon">
                            ...
                            <svg width="40" height="34" viewBox="-4 -4 40 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <!-- Left bar -->
                                <path d="M0 26 V14 C0 11.79 1.79 10 4 10 C6.21 10 8 11.79 8 14 V26 Z" fill="#5D6D82"/>
                                <!-- Middle bar -->
                                <path d="M12 26 V10 C12 7.79 13.79 6 16 6 C18.21 6 20 7.79 20 10 V26 Z" fill="#E8D595"/>
                                <!-- Right bar -->
                                <path d="M24 26 V4 C24 1.79 25.79 0 28 0 C30.21 0 32 1.79 32 4 V26 Z" fill="#D4A84F" style="filter: drop-shadow(0px 0px 8px rgba(212,168,79,0.9));"/>
                            </svg>
                        </div>
                    ...
                    <div class="addon-col">
                        ...
                        <div class="addon-icon">
                            ...
                            <svg width="44" height="32" viewBox="-4 -4 44 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <circle cx="26" cy="12" r="10" stroke="#E8D595" stroke-width="2.5"/>
                                <!-- Left ring drawn second -->
                                <circle cx="12" cy="12" r="10" stroke="#D4A84F" stroke-width="2.5" style="filter: drop-shadow(0px 0px 6px rgba(212,168,79,0.8));"/>
                                <!-- Faint inner glow -->
