...
add_action('wp_head', function() {
    ...
    // Inline critical hero background CSS so WP Rocket cannot lazy-load it
    echo '<style>.hero{background-image:linear-gradient(rgba(0,0,0,.705),rgba(0,0,0,.705)),url("https://www.communitytax.com/wp-content/uploads/2023/09/File-or-Pay-Taxes.webp")!important;background-size:cover!important;background-position:center!important;}</style>';
});
