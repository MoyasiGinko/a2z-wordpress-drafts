    ...
    <section class="hero">
        <div class="container hero-content">
            ...
            <div class="hero-actions">
                <a href="#a2z-enquire" onclick="window.location.hash='a2z-enquire'; event.preventDefault();" class="btn btn-solid">Start Your Enquiry</a>
                <a href="#a2z-feequote" onclick="window.location.hash='a2z-feequote'; event.preventDefault();" class="btn btn-outline">Get An Fee Estimate</a>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('a[href^="#"]').forEach(anchor => {
                anchor.addEventListener('click', function(e) {
                    ...
                    // Bypass smooth scrolling for form popup hashes
                    if (href === '#a2z-enquire' || href === '#a2z-feequote') return;
