...
.a2z-watermark {
  ...
  right: clamp(-10%, -6vw, -5%);
  font-family: var(--serif);
  font-size: clamp(14rem, 25vw, 32rem);
...
@media (max-width: 900px) {
  .a2zvt-new__slide:not(.is-center) .a2zvt-new__body { opacity: 0; transition: opacity 0.3s; }
  .a2zvt-new__slide.is-center .a2zvt-new__body { opacity: 1; transition: opacity 0.4s 0.2s; }
}
...
.contact-inner {
  ...
  max-width: 900px;
  margin: 0 auto;
  padding: clamp(250px, 40vw, 405px) 0 clamp(60px, 8vw, 100px) 0;
}
.cta-box {
  background-color: #112B46;
  width: 100%;
  max-width: 768px;
  min-height: clamp(400px, 50vw, 509px);
  margin: 0 auto;
