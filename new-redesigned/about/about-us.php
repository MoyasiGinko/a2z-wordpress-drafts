...
.reviews {
  background: #fff;
  padding: 20px 0 clamp(60px, 8vw, 100px) 0;
  position: relative;
  overflow: hidden;
}
...
.faq {
  background: var(--white);
  padding: clamp(60px, 11vw, 100px) clamp(14px, 4vw, 72px);
  position: relative;
}
...
.faq-header .display-lg em {
  ...
  text-transform: capitalize;
  color: #D4A850;
  -webkit-text-stroke: 0.6px #D4A850;
}
...
<link rel="preload" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=DM+Sans:wght@300;400;500&family=DM+Mono:wght@300;400&family=Hanken+Grotesk:wght@700&family=Inter:wght@600;700&family=Libre+Caslon+Text:wght@400&family=Manrope:wght@500;600;700;800&family=Montserrat:wght@600&family=Playfair+Display:ital,wght@0,700;0,800;1,700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'" />
<noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=DM+Sans:wght@300;400;500&family=DM+Mono:wght@300;400&family=Hanken+Grotesk:wght@700&family=Inter:wght@600;700&family=Libre+Caslon+Text:wght@400&family=Manrope:wght@500;600;700;800&family=Montserrat:wght@600&family=Playfair+Display:ital,wght@0,700;0,800;1,700&display=swap" /></noscript>
  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-ctas desk-res">
        <a href="<?php echo esc_url(get_permalink()); ?>#a2z-enquire" class="btn-cstm btn-gold">Speak With Our Team</a>
        <a href="<?php echo esc_url(get_permalink()); ?>#a2z-feequote" class="btn-cstm btn-ghost-light">Get A Fee Estimate</a>
      </div>
    </div>
    ...
    <div class="founder-split-grid reveal d1">
      ...
      <div class="fm-right-col">
        ...
        <div class="fm-image-wrapper">
          <img src="https://a2zaccounting.co.uk/wp-content/uploads/2026/04/srahman.png" alt="Shabbir Rahman, Founder" width="480" height="480" loading="lazy" style="aspect-ratio: 1 / 1; object-fit: cover;">
    ...
    <div class="tm-metrics-grid reveal d1">
      ...
      <div class="tm-metric-card">
        <div class="tm-metric-icon">
          <!-- Trend Up SVG -->
          <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/trending-up.svg" alt="Trending Up" width="32" height="32" loading="lazy">
        </div>
      ...
      <div class="tm-metric-card">
        <div class="tm-metric-icon">
          <!-- Verified Badge SVG -->
          <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/badge-check.svg" alt="Verified" width="32" height="32" loading="lazy">
        </div>
      ...
      <div class="tm-metric-card">
        <div class="tm-metric-icon">
          <!-- Clock SVG -->
          <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/clock.svg" alt="Clock" width="32" height="32" loading="lazy">
        </div>
      ...
      <div class="tm-metric-card">
        <div class="tm-metric-icon">
          <!-- Gavel SVG -->
          <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/gavel.svg" alt="Gavel" width="32" height="32" loading="lazy">
        </div>
        <div class="tm-metric-num"><span class="metric-num">£0</span></div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function startAutoplay() {
            ...
            autoplayInterval = setInterval(function() {
                if (!busy && !document.querySelector('.lity')) {
                    moveNext();
                }
            }, 5000);
        }
        ...
        if (outer) {
            ...
            outer.addEventListener('touchstart', stopAutoplay, { passive: true });
        }
...
<section class="diff-section">
  ...
  <div class="diff-badges reveal d2">
    ...
    <div class="diff-badge">
      <div class="db-icon">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/shield-check.svg" alt="Shield" width="32" height="32" loading="lazy">
      </div>
      <div class="db-text">
    ...
    <div class="diff-badge">
      <div class="db-icon">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/landmark.svg" alt="Bank" width="32" height="32" loading="lazy">
      </div>
      <div class="db-text">
    ...
    <div class="diff-badge">
      <div class="db-icon">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/file-text.svg" alt="File" width="32" height="32" loading="lazy">
      </div>
      <div class="db-text">
...
.a2zvt-new__slide { flex: 0 0 clamp(0px, 20.705vw, 229px); width: clamp(0px, 20.705vw, 229px); margin-right: clamp(0px, 2.17vw, 24px); transition: transform 0.6s cubic-bezier(0.25, 1, 0.5, 1), opacity 0.6s cubic-bezier(0.25, 1, 0.5, 1), width 0.6s cubic-bezier(0.25, 1, 0.5, 1), border-color 0.6s cubic-bezier(0.25, 1, 0.5, 1); opacity: 1; position: relative; border-radius: 4.58px; overflow: hidden; border: 0.76px solid rgba(255,255,255,0.05); background: #000; }
...
.a2zvt-new__play-icon-img { width: 12px; height: 12px; margin-left: 2px; filter: invert(13%) sepia(35%) saturate(542%) hue-rotate(170deg) brightness(90%) contrast(92%); transition: transform 0.3s, filter 0.3s, opacity 0.3s; }
...
.a2zvt-new-global-prev, .a2zvt-new-global-next { position: absolute; top: 50%; transform: translateY(-50%); width: 44px; height: 44px; border-radius: 50%; background: #182f45; border: 1px solid rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 10; transition: background-color 0.3s, border-color 0.3s, transform 0.3s, opacity 0.3s; }
                        ...
                        <div class="a2zvt-new__slide' . $is_center_class . '">
                            <a href="' . htmlspecialchars($t['link']) . '"
                                data-lity class="a2zvt-new__thumb"><img class="a2zvt-new__thumb-img"
                                    ...
                                    alt="' . htmlspecialchars(strip_tags($t['name'])) . '" width="320" height="180" loading="lazy" style="aspect-ratio: 16 / 9; object-fit: cover;"><span class="a2zvt-new__play"><svg class="a2zvt-new__play-icon-img" viewBox="0 0 24 24" fill="#000" stroke="none"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></span></a>
...
<section class="contact">
  <div class="contact-inner reveal">
    <div class="cta-box">
      ...
      <a href="<?php echo esc_url(get_permalink()); ?>#a2z-enquire" class="btn-cstm btn-gold">SPEAK WITH A CHARTERED CERTIFIED ACCOUNTANT</a>
      <p class="cta-note">
        ...
        <div class="reviews-inner">
            ...
            <div class="reviews-footer a2zh-rv a2zh-d2" style="display: flex; justify-content: center;">
                <div class="reviews-footer-logo">
                    <img src="https://cdn.trustindex.io/assets/platform/Google/icon.svg" alt="Google" width="24" height="24" loading="lazy" />
