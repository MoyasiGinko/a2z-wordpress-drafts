...
<section class="hero">
  ...
  <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@700&family=Libre+Caslon+Text:wght@400&family=Manrope:wght@500;600;700;800&family=Playfair+Display:ital,wght@0,700;0,800;1,700&display=swap');
    .hero {
...
.fm-floating-badge {
  position: absolute;
  bottom: -52px; /* Aligns correctly over the image edge */
  left: 50%;
  transform: translateX(-50%);
  background: #ffffff;
  padding: 16px 20px;
...
.tm-metric-num {
  ...
  vertical-align: middle;
  color: #ffffff;
  margin-bottom: 8px; /* Adjusted slightly to fit the new 154px height */
}
