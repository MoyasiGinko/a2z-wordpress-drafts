...
<style>
.testimonials-dark { background-color: #112B46; padding: 100px 0; overflow: hidden; position: relative; min-height: 789px; display: flex; flex-direction: column; justify-content: center; }
