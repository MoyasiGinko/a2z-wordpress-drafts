...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function movePrev() {
            ...
            if (newSlides[0]) newSlides[0].classList.add('is-center');
            track.style.transition = 'transform 0.6s cubic-bezier(0.25, 1, 0.5, 1)';
            track.style.transform = 'translate3d(0, 0, 0)';
            setTimeout(function() {
                busy = false;
...
.diff-grid > .diff-cell:nth-child(3n+1) {
...
.diff-cell.a2z {
  ...
  vertical-align: middle;
  color: #000000;
  border-left: 1.5px solid #D4A850;
  border-right: 1.5px solid #D4A850;
}

/* Cell Specifics */
.diff-cell.head {
  min-height: clamp(56px, 8vw, 74.91px);
  background: #ECEEF0;
  font-family: 'Manrope', sans-serif;
  font-weight: 600;
  font-size: clamp(16px, 2vw, 21.95px);
  line-height: 1.4;
  letter-spacing: 0px;
  vertical-align: middle;
  color: #111;
...
.diff-cell.head.a2z {
  font-weight: 800;
  color: #9B4500;
  border-top: 1.5px solid #D4A850;
}
.diff-cell.last.a2z {
  border-bottom: 1.5px solid #D4A850;
}
.diff-cell.criteria {
  font-family: 'Manrope', sans-serif;
  font-weight: 600;
...
.diff-cell.a2z img {
  ...
  filter: invert(27%) sepia(89%) saturate(3195%) hue-rotate(17deg) brightness(96%) contrast(101%); /* Match #9B4500 */
}
...
<section class="diff-section">
  ...
  <div class="diff-grid reveal d1">
    ...
    <!-- Row 1 -->
    <div class="diff-cell criteria bg-white" style="border-bottom: none;">WHO HANDLES IT</div>
    <div class="diff-cell typical bg-white" style="border-bottom: none;">One stretched generalist</div>
    <div class="diff-cell a2z" style="border-bottom: none;"><img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/users.svg" alt="Users"> A dedicated specialist team</div>
    ...
    <!-- Row 3 -->
    <div class="diff-cell criteria bg-white" style="border-bottom: none;">RESPONSE TIME</div>
    <div class="diff-cell typical bg-white" style="border-bottom: none;">Days, or no reply</div>
    <div class="diff-cell a2z" style="border-bottom: none;"><img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/clock.svg" alt="Clock"> Same-day before midday</div>
    ...
    <!-- Row 5 -->
    <div class="diff-cell criteria bg-white" style="border-bottom: none;">TAX PLANNING</div>
    <div class="diff-cell typical bg-white" style="border-bottom: none;">You ask, they react</div>
    <div class="diff-cell a2z" style="border-bottom: none;"><img src="https://cdn.jsdelivr.net/npm/lucide-static@0.326.0/icons/trending-up.svg" alt="Trending Up"> Planned months ahead</div>
    ...
    <!-- Row 7 -->
    <div class="diff-cell criteria bg-white">SECTOR KNOWLEDGE</div>
    <div class="diff-cell typical bg-white">Generalist, applied broadly</div>
...
.a2zvt-new__slide.is-center { flex: 0 0 clamp(0px, 54.249vw, 600px); width: clamp(0px, 54.249vw, 600px); border-radius: 12px; border-width: 1px; z-index: 2; box-shadow: 0 20px 50px rgba(0,0,0,0.5); border-color: rgba(212,168,79,0.3); opacity: 1; }
...
.a2zvt-new__slide.is-center .a2zvt-new__body { padding: clamp(16px, 4vw, 32px); }
...
@media (max-width: 900px) {
  .a2zvt-new-clip { height: auto !important; padding: 40px 0 !important; }
  .a2zvt-new__track { margin-left: calc(-17.5vw - 12px) !important; }
  .a2zvt-new__slide { flex: 0 0 30vw !important; width: 30vw !important; margin-right: 12px !important; border-radius: 6px !important; }
  .a2zvt-new__slide.is-center { flex: 0 0 75vw !important; width: 75vw !important; border-radius: 8px !important; }
  .a2zvt-new__thumb-img { object-position: center !important; }
  
  .a2zvt-new__slide:not(.is-center) .a2zvt-new__body { opacity: 0 !important; pointer-events: none; }
  
  .a2zvt-new__slide.is-center .a2zvt-new__body { padding: 12px 16px !important; opacity: 1 !important; transition: opacity 0.4s 0.2s; }
...
<section class="contact">
  <div class="contact-inner reveal">
    <div class="cta-box">
      ...
      <a href="/contact/" class="btn btn-gold">SPEAK WITH A CHARTERED CERTIFIED ACCOUNTANT</a>
      <p class="cta-note">
