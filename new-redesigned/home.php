...
// COMPLETE BLOCK: Start PHP output buffering to defer heavy 3rd-party scripts and fix resource hints
ob_start(function($html) {
    // 1. Force defer on external scripts (like Trustindex reviews) so they never cause reflows or block First Contentful Paint
    $html = preg_replace('/<script([^>]*)src=["\']([^"\']*(trustindex\.io|gtag|google-analytics)[^"\']*)["\']([^>]*)>/i', '<script$1src="$2" defer="defer"$3>', $html);

    // 2. Fix resource hints. Lighthouse reports the googletagmanager and js.stripe.com
    // preconnects as unused, while cdnjs.cloudflare.com -- which serves the 155 KiB
    // fa-solid-900.woff2 at the end of the critical chain -- has no preconnect at all.
    $html = preg_replace(
        '/<link[^>]*rel=["\']preconnect["\'][^>]*href=["\'][^"\']*(googletagmanager\.com|js\.stripe\.com)[^"\']*["\'][^>]*>/i',
        '',
        $html
    );
    $html = preg_replace(
        '/<link[^>]*href=["\'][^"\']*(googletagmanager\.com|js\.stripe\.com)[^"\']*["\'][^>]*rel=["\']preconnect["\'][^>]*>/i',
        '',
        $html
    );
    // cdnjs is the only third-party origin left on the critical path (Font Awesome, loaded
    // by the theme header). jsdelivr and unpkg preconnects were dropped when the three icons
    // they served were inlined as SVG. Unsplash/Cloudinary are lazy-loaded, so no hint needed.
...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,700&family=Hanken+Grotesk:wght@400;600;700&family=Inter:wght@400;500;600;700&family=Libre+Caslon+Text:ital,wght@0,400;0,700;1,400&family=Manrope:wght@400;600;700&family=Playfair+Display:ital,wght@0,600;0,700;0,800;1,600;1,700&family=Plus+Jakarta+Sans:wght@400;600;700&family=Poltawski+Nowy:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet">
...
<style>
	...
	.btn-cstm::before {
        ...
        .a2z3t h2 em {
            ...
            text-transform: none;
            font-size: 1.16em;
            -webkit-text-stroke: 0.6px #C4905A;
        }
        .a2z3t-grid {
            display: grid;
            grid-template-columns: 1fr;
        ...
        .a2zlv h2 em {
            ...
            color: #B07D3C;
            font-size: 1.16em;
            -webkit-text-stroke: 0.6px #B07D3C;
        }
        .a2zlv-grid {
            display: grid;
            grid-template-columns: 1fr;
    ...
    <section class="hero">
        <div class="section-container hero-content">
            ...
            <div class="hero-actions">
                <a href="<?php echo esc_url(get_permalink()); ?>#a2z-enquire" class="btn-cstm btn-solid">Start Your Enquiry</a>
                <a href="<?php echo esc_url(get_permalink()); ?>#a2z-feequote" class="btn-cstm btn-outline">Get A Fee Estimate</a>
            </div>
                ...
                <div class="hero-card" id="heroTestimonialCard">
                    ...
                    <div class="hero-card-video">
                        ...
                        <div id="heroVideoPlay" class="hero-card-play" onclick="playLoomVideo()">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" role="img" aria-label="Play Video" style="width: 24px; height: 24px;"><path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393"/></svg>
                        </div>
                    </div>
    ...
    <section class="section-white" style="padding-top: 40px; padding-bottom: 80px;" id="reception-banner">
        <div class="section-container">
            <div class="reception-banner-wrapper">
                <img src="https://a2zaccounting.co.uk/wp-content/uploads/2025/08/Home-Page-photo.webp" alt="A2Z Accounting Office" class="reception-img" width="1132" height="623" loading="lazy" decoding="async">
                    ...
                    <div class="tax-content">
                        <div class="tax-card">
                            ...
                            <div class="tax-card-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Strategy Icon"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tax-timeline-row tax-row-card">
                    ...
                    <div class="tax-content">
                        <div class="tax-card">
                            ...
                            <div class="tax-card-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Compliance Icon"><path d="M3 3v18h18"/><path d="M13 17V9"/><path d="M18 17V5"/><path d="M8 17v-3"/></svg>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="switching-grid">
                ...
                <div class="switching-card">
                    <div class="sc-img-box">
                        <img src="https://res.cloudinary.com/dvvcwzp4n/image/upload/v1784193091/Discovery_Conversation_wkjcds.png" alt="Discovery Call" width="400" height="256" loading="lazy" decoding="async">
                    </div>
                    <div class="sc-body">
                ...
                <div class="switching-card">
                    <div class="sc-img-box">
                        <img src="https://res.cloudinary.com/dvvcwzp4n/image/upload/v1784193091/Structured_Handover_tittu0.png" alt="Handover" width="400" height="256" loading="lazy" decoding="async">
                    </div>
                    <div class="sc-body">
                        <div class="sc-header-row">
                ...
                <div class="switching-card">
                    <div class="sc-img-box">
                        <img src="https://res.cloudinary.com/dvvcwzp4n/image/upload/v1784193091/Ongoing_Management_omrii7.png" alt="Ongoing Management" width="400" height="256" loading="lazy" decoding="async">
                    </div>
                    <div class="sc-body">
                        <div class="sc-header-row">
                    ...
                    foreach ($latest_blogs as $post) :
                        ...
                        <div class="blog-card">
                            <div class="blog-img-box">
                                ...
                                <img src="<?php echo esc_url($img_url); ?>" alt="<?php echo esc_attr($post_title); ?>" loading="lazy" decoding="async">
                            </div>
                            <div class="blog-body">
                                <div class="blog-meta">
                ...
                <div class="table-wraper">
                    <form id="calculator_form" class="pricing-calculator-form">
                        ...
                        <div class="inputouter m-3 text-center">
                            <input type="submit" value="Request A Quote" class="btn-cstm">
...
jQuery(document).ready(function($) {
    ...
    $("#calculator-client-details").validate({
        ...
        submitHandler: function(form) {
            ...
            var $submitBtn = $(form).find("input[type=submit].btn-cstm");
...
<div id="a2z-feequote" class="a2z-modal a2z-fx" role="dialog" aria-modal="true" aria-labelledby="fqTitle">
  ...
  <div class="a2z-modal__panel">
    ...
    <a href="#!" class="btn-cstm btn-gold a2z-eform__submit" data-bs-toggle="modal" data-bs-target="#gitModal">Continue to your instant estimate</a>
  </div>
</div>
...
<div id="a2z-enquire" class="a2z-modal a2z-fx" role="dialog" aria-modal="true" aria-labelledby="eqTitle">
  ...
  <div class="a2z-modal__panel">
    ...
    <a href="#!" class="btn-cstm btn-gold a2z-eform__submit" data-bs-toggle="modal" data-bs-target="#enquireModal" data-source="Start Your Enquiry">Continue to your enquiry</a>
  </div>
</div>
