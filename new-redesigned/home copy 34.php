...
<!-- ==========================================
    ...
    <section class="hero">
        <div class="container hero-content">
            ...
            <div class="hero-actions">
                <a href="https://a2zaccounting.co.uk/home-cstm/#a2z-enquire" target="_self">example1</a>
                <button type="button" class="btn btn-solid" data-bs-toggle="modal" data-bs-target="#enquireModal" data-source="Start Your Enquiry">Start Your Enquiry</button>
                <a href="https://a2zaccounting.co.uk/home-cstm/#a2z-feequote" target="_self">example2</a>
                <button type="button" class="btn btn-outline" data-bs-toggle="modal" data-bs-target="#gitModal">Get An Fee Estimate</button>
            </div>
    ...
    <section class="price-guarantee-section" id="price-guarantee">
        <div class="container">
            ...
            <a href="javascript:void(0)" class="pg-btn" data-bs-toggle="modal" data-bs-target="#gitModal">GET A FEE ESTIMATE</a>
        </div>
    </section>
