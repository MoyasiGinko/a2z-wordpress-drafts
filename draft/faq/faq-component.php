...
<section class="faq-section">
  <div class="faq-inner">
    <div class="faq-header">
      <div class="rv">
        <h2 class="faq-title">
          Questions our clients<br /><span>ask us every day</span>
        </h2>
      </div>
    </div>
    ...
    <div class="faq-grid rv d3" id="faqGrid" data-limit="<?= (int) $limit ?>" data-total="<?= (int) $total ?>">
      <?php
              ...
              foreach ($list as $i => $row) {
                  ...
                  $html = '<div class="faq-item' . $hidden . '" data-index="' . $i . '">'
                    . '<div class="faq-q">'
                    . '<span class="faq-q-text"><span class="faq-q-question"><span class="faq-q-num">' . $num . '</span> ' . $q . '</span></span>'
              ...
              ?>
      <div class="faq-col"><?php foreach ($left  as $h) echo $h; ?></div>
      <div class="faq-col"><?php foreach ($right as $h) echo $h; ?></div>
...
:root {
  ...
  --faq-serif: "Plus Jakarta Sans", sans-serif;
  --faq-sans: "Plus Jakarta Sans", sans-serif;
}
...
.faq-title {
  ...
  font-weight: 600;
  font-size: clamp(1.625rem, 0.625vw + 1.5rem, 2.25rem);
  line-height: clamp(2.25rem, 0.75vw + 2.1rem, 3rem);
